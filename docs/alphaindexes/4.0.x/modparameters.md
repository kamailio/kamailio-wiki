...
| **attribute_column (string)**                                                | *modules*   | [avpops](http://www.kamailio.org/docs/modules/4.0.x/modules/avpops.html)               |
...
| **callee_service_type (integer)**       | *modules*   | [misc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/misc_radius.html)       |
...
| **char_list (string)**                  | *modules*   | [mtree](http://www.kamailio.org/docs/modules/4.0.x/modules/mtree.html)                   |
...
| **credential (string)**                 | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                       |
...
| **db_table (string)**                 | *modules*   | [cpl-c](http://www.kamailio.org/docs/modules/4.0.x/modules/cpl-c.html)                 |
...
| **db_url (string)**                   | *modules*   | [mtree](http://www.kamailio.org/docs/modules/4.0.x/modules/mtree.html)                 |
...
| **default_timeout (integer)**         | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)               |
...
| **dlg_flag (integer)**                | *modules*   | [dialog_ng](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog_ng.html)         |
...
| **dont_strip_or_tag_flag (integer)**  | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                     |
...
| **flush (integer)**                          | *modules*   | [db_flatstore](http://www.kamailio.org/docs/modules/4.0.x/modules/db_flatstore.html)               |
...
| **include_localremote (int)**           | *modules*   | [pua_dialoginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_dialoginfo.html) |
...
| **long_format (integer)**            | *modules*   | [xlog](http://www.kamailio.org/docs/modules/4.0.x/modules/xlog.html)               |
...
| **method_filtering (integer)**       | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)         |
...
| Name                               | Module Path | Module Name                                                                      |
|------------------------------------|-------------|----------------------------------------------------------------------------------|
| **name (string)**                  | *modules*   | [ims_auth](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_auth.html)     |
| **name (string)**                  | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_avp_db.html) |
| **name_col (string)**              | *modules*   | [domain](http://www.kamailio.org/docs/modules/4.0.x/modules/domain.html)         |
| **natping_interval (integer)**     | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)   |
| **natping_processes (integer)**    | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)   |
| **natping_socket (string)**        | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)   |
| **nat_bflag (integer)**            | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)         |
| **nc_array_order (integer)**       | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)             |
| **nc_array_size (integer)**        | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)             |
| **networks (string)**              | *modules*   | [sms](http://www.kamailio.org/docs/modules/4.0.x/modules/sms.html)               |
| **new_uri_column (string)**        | *modules*   | [speeddial](http://www.kamailio.org/docs/modules/4.0.x/modules/speeddial.html)   |
| **nid_pool_no (integer)**          | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)             |
| **noisy_ctimer (integer)**         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                 |
| **nonce_auth_max_drift (integer)** | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)             |
| **nonce_count (boolean)**          | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)             |
| **nonce_expire (integer)**         | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)             |
| **nortpproxy_str (string)**        | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)   |
| **nortpproxy_str (string)**        | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.0.x/modules/rtpproxy.html)     |
| **notifier_poll_rate (int)**       | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)     |
| **notifier_poll_rate (int)**       | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)               |
| **notifier_processes (int)**       | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)     |
| **notifier_processes (int)**       | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)               |
| **num_column (string)**            | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html)     |

## \[O\]

| Name                                 | Module Path | Module Name                                                                              |
|--------------------------------------|-------------|------------------------------------------------------------------------------------------|
| **offline_message (string)**         | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **one_time_nonce (boolean)**         | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)                     |
| **on_sl_reply (string)**             | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                         |
| **options_accept (string)**          | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.0.x/modules/siputils.html)             |
| **options_accept_encoding (string)** | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.0.x/modules/siputils.html)             |
| **options_accept_language (string)** | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.0.x/modules/siputils.html)             |
| **options_support (string)**         | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.0.x/modules/siputils.html)             |
| **otn_in_flight_no (integer)**       | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)                     |
| **otn_in_flight_order (integer)**    | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)                     |
| **outbound_mode (integer)**          | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)           |
| **outbound_proxy (str)**             | *modules*   | [dispatcher](http://www.kamailio.org/docs/modules/4.0.x/modules/dispatcher.html)         |
| **outbound_proxy (str)**             | *modules*   | [imc](http://www.kamailio.org/docs/modules/4.0.x/modules/imc.html)                       |
| **outbound_proxy (str)**             | *modules*   | [pua](http://www.kamailio.org/docs/modules/4.0.x/modules/pua.html)                       |
| **outbound_proxy (str)**             | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                       |
| **outbound_proxy (string)**          | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **outbound_proxy (string)**          | *modules*   | [xmpp](http://www.kamailio.org/docs/modules/4.0.x/modules/xmpp.html)                     |
| **outbound_proxy(str)**              | *modules*   | [pua_bla](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_bla.html)               |
| **outbound_proxy(str)**              | *modules*   | [pua_reginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_reginfo.html)       |
| **override_lifetime (int)**          | *modules*   | [pua_dialoginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_dialoginfo.html) |

## \[P\]

| Name                                                | Module Path | Module Name                                                                              |
|-----------------------------------------------------|-------------|------------------------------------------------------------------------------------------|
| **params_column (string)**                          | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                       |
| **passive_mode(int)**                               | *modules*   | [presence_xml](http://www.kamailio.org/docs/modules/4.0.x/modules/presence_xml.html)     |
| **password_column (string)**                        | *modules*   | [auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_db.html)               |
| **password_column (string)**                        | *modules*   | [uid_auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_auth_db.html)       |
| **password_column_2 (string)**                      | *modules*   | [auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_db.html)               |
| **password_column_2 (string)**                      | *modules*   | [uid_auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_auth_db.html)       |
| **pass_provisional_replies (integer)**              | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                         |
| **path (string)**                                   | *modules*   | [geoip](http://www.kamailio.org/docs/modules/4.0.x/modules/geoip.html)                   |
| **path_column (string)**                            | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)                 |
| **path_mode (integer)**                             | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)           |
| **path_use_received (integer)**                     | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)           |
| **pcre_caseless (int)**                             | *modules*   | [regex](http://www.kamailio.org/docs/modules/4.0.x/modules/regex.html)                   |
| **pcre_dotall (int)**                               | *modules*   | [regex](http://www.kamailio.org/docs/modules/4.0.x/modules/regex.html)                   |
| **pcre_extended (int)**                             | *modules*   | [regex](http://www.kamailio.org/docs/modules/4.0.x/modules/regex.html)                   |
| **pcre_multiline (int)**                            | *modules*   | [regex](http://www.kamailio.org/docs/modules/4.0.x/modules/regex.html)                   |
| **peer_tag_avp (AVP string)**                       | *modules*   | [permissions](http://www.kamailio.org/docs/modules/4.0.x/modules/permissions.html)       |
| **peer_tag_mode (integer)**                         | *modules*   | [permissions](http://www.kamailio.org/docs/modules/4.0.x/modules/permissions.html)       |
| **periodical_query(int)**                           | *modules*   | [xcap_client](http://www.kamailio.org/docs/modules/4.0.x/modules/xcap_client.html)       |
| **persistence**                                     | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                       |
| **pike_log_level (integer)**                        | *modules*   | [pike](http://www.kamailio.org/docs/modules/4.0.x/modules/pike.html)                     |
| **ping_application_data (string)**                  | *modules*   | [websocket](http://www.kamailio.org/docs/modules/4.0.x/modules/websocket.html)           |
| **ping_interval (int)**                             | *modules*   | [db_unixodbc](http://www.kamailio.org/docs/modules/4.0.x/modules/db_unixodbc.html)       |
| **ping_interval (integer)**                         | *modules*   | [db_mysql](http://www.kamailio.org/docs/modules/4.0.x/modules/db_mysql.html)             |
| **ping_nated_only (integer)**                       | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)           |
| **pipe (integer:string:integer)**                   | *modules*   | [ratelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/ratelimit.html)           |
| **plain_password_column (string)**                  | *modules*   | [uid_auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_auth_db.html)       |
| **plp_algorithm_column (string)**                   | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/pipelimit.html)           |
| **plp_limit_column (string)**                       | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/pipelimit.html)           |
| **plp_pipeid_column (string)**                      | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/pipelimit.html)           |
| **plp_table_name (string)**                         | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/pipelimit.html)           |
| **port(integer)**                                   | *modules*   | [mi_xmlrpc](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_xmlrpc.html)           |
| **port_col (string)**                               | *modules*   | [permissions](http://www.kamailio.org/docs/modules/4.0.x/modules/permissions.html)       |
| **port_column (string)**                            | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                       |
| **port_override_avp (string)**                      | *modules*   | [domainpolicy](http://www.kamailio.org/docs/modules/4.0.x/modules/domainpolicy.html)     |
| **prefix (str)**                                    | *modules*   | [xlog](http://www.kamailio.org/docs/modules/4.0.x/modules/xlog.html)                     |
| **prefix (string)**                                 | *modules*   | [pdt](http://www.kamailio.org/docs/modules/4.0.x/modules/pdt.html)                       |
| **prefix_column (string)**                          | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                       |
| **prefix_column (string)**                          | *modules*   | [pdt](http://www.kamailio.org/docs/modules/4.0.x/modules/pdt.html)                       |
| **preload (string)**                                | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)                 |
| **presentity_table(str)**                           | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)             |
| **pres_db_url (string)**                            | *modules*   | [utils](http://www.kamailio.org/docs/modules/4.0.x/modules/utils.html)                   |
| **pres_htable_size (int)**                          | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)             |
| **priority_col (string)**                           | *modules*   | [dispatcher](http://www.kamailio.org/docs/modules/4.0.x/modules/dispatcher.html)         |
| **priority_column (string)**                        | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                       |
| **privatekey_path (string)**                        | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_identity.html)   |
| **private_key (string)**                            | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **private_key, local_certificate, ca_certificates** | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                       |
| **profiles_no_value (string)**                      | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                 |
| **profiles_no_value (string)**                      | *modules*   | [dialog_ng](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog_ng.html)           |
| **profiles_with_value (string)**                    | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                 |
| **profiles_with_value (string)**                    | *modules*   | [dialog_ng](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog_ng.html)           |
| **promiscuous_on (integer)**                        | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/4.0.x/modules/sipcapture.html)         |
| **proto_col (string)**                              | *modules*   | [permissions](http://www.kamailio.org/docs/modules/4.0.x/modules/permissions.html)       |
| **proxy_recurse (int)**                             | *modules*   | [cpl-c](http://www.kamailio.org/docs/modules/4.0.x/modules/cpl-c.html)                   |
| **proxy_require (string)**                          | *modules*   | [sanity](http://www.kamailio.org/docs/modules/4.0.x/modules/sanity.html)                 |
| **proxy_route (int)**                               | *modules*   | [cpl-c](http://www.kamailio.org/docs/modules/4.0.x/modules/cpl-c.html)                   |
| **pr_col (string)**                                 | *modules*   | [dialplan](http://www.kamailio.org/docs/modules/4.0.x/modules/dialplan.html)             |
| **publish_reginfo(int)**                            | *modules*   | [pua_reginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_reginfo.html)       |
| **publ_cache (int)**                                | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)             |
| **pubruri_callee_avp (int)**                        | *modules*   | [pua_dialoginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_dialoginfo.html) |
| **pubruri_caller_avp (int)**                        | *modules*   | [pua_dialoginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_dialoginfo.html) |
| **purge_expired_interval (integer)**                | *modules*   | [sca](http://www.kamailio.org/docs/modules/4.0.x/modules/sca.html)                       |
| **pv_value (string)**                               | *modules*   | [mtree](http://www.kamailio.org/docs/modules/4.0.x/modules/mtree.html)                   |
| **pv_values (string)**                              | *modules*   | [mtree](http://www.kamailio.org/docs/modules/4.0.x/modules/mtree.html)                   |

## \[Q\]

| Name                       | Module Path | Module Name                                                                        |
|----------------------------|-------------|------------------------------------------------------------------------------------|
| **qop (string)**           | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)               |
| **qos_flag (integer)**     | *modules*   | [qos](http://www.kamailio.org/docs/modules/4.0.x/modules/qos.html)                 |
| **query_period(int)**      | *modules*   | [xcap_client](http://www.kamailio.org/docs/modules/4.0.x/modules/xcap_client.html) |
| **queue (integer:string)** | *modules*   | [ratelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/ratelimit.html)     |
| **q_column (string)**      | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)           |

## \[R\]

| Name                                        | Module Path | Module Name                                                                        |
|---------------------------------------------|-------------|------------------------------------------------------------------------------------|
| **radius_config (string)**                  | *modules*   | [acc](http://www.kamailio.org/docs/modules/4.0.x/modules/acc.html)                 |
| **radius_config (string)**                  | *modules*   | [acc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/acc_radius.html)   |
| **radius_config (string)**                  | *modules*   | [auth_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_radius.html) |
| **radius_config (string)**                  | *modules*   | [misc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/misc_radius.html) |
| **radius_config (string)**                  | *modules*   | [peering](http://www.kamailio.org/docs/modules/4.0.x/modules/peering.html)         |
| **radius_extra (string)**                   | *modules*   | [acc](http://www.kamailio.org/docs/modules/4.0.x/modules/acc.html)                 |
| **radius_extra (string)**                   | *modules*   | [acc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/acc_radius.html)   |
| **radius_flag (integer)**                   | *modules*   | [acc](http://www.kamailio.org/docs/modules/4.0.x/modules/acc.html)                 |
| **radius_flag (integer)**                   | *modules*   | [acc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/acc_radius.html)   |
| **radius_missed_flag (integer)**            | *modules*   | [acc](http://www.kamailio.org/docs/modules/4.0.x/modules/acc.html)                 |
| **radius_missed_flag (integer)**            | *modules*   | [acc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/acc_radius.html)   |
| **raw_interface (string)**                  | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/4.0.x/modules/sipcapture.html)   |
| **raw_ipip_capture_on (integer)**           | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/4.0.x/modules/sipcapture.html)   |
| **raw_moni_bpf_on (integer)**               | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/4.0.x/modules/sipcapture.html)   |
| **raw_moni_capture_on (integer)**           | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/4.0.x/modules/sipcapture.html)   |
| **raw_socket_listen (string)**              | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/4.0.x/modules/sipcapture.html)   |
| **raw_sock_children (integer)**             | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/4.0.x/modules/sipcapture.html)   |
| **read_db_url (string)**                    | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html)       |
| **realm_prefix (string)**                   | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)               |
| **realm_prefix (string)**                   | *modules*   | [cpl-c](http://www.kamailio.org/docs/modules/4.0.x/modules/cpl-c.html)             |
| **realm_prefix (string)**                   | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)     |
| **received_avp (str)**                      | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)     |
| **received_avp (str)**                      | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)     |
| **received_column (string)**                | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)           |
| **received_param (string)**                 | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)     |
| **reconnect (fixedpoint)**                  | *modules*   | [db_oracle](http://www.kamailio.org/docs/modules/4.0.x/modules/db_oracle.html)     |
| **redirection_uri_format**                  | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                 |
| **reginfo_increase_version (int)**          | *modules*   | [pua](http://www.kamailio.org/docs/modules/4.0.x/modules/pua.html)                 |
| **register (string)**                       | *modules*   | [app_lua](http://www.kamailio.org/docs/modules/4.0.x/modules/app_lua.html)         |
| **register_myself (integer)**               | *modules*   | [domain](http://www.kamailio.org/docs/modules/4.0.x/modules/domain.html)           |
| **registration_default_algorithm (string)** | *modules*   | [ims_auth](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_auth.html)       |
| **registration_qop (string)**               | *modules*   | [ims_auth](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_auth.html)       |
| **reg_callid_avp (string)**                 | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)     |
| **reg_contact_addr (string)**               | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **reg_db_table (string)**                   | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html)       |
| **reg_db_table (string)**                   | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **reg_db_url (string)**                     | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **reg_retry_interval (int)**                | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **reg_timer_interval (string)**             | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **reject_to_small (integer)**               | *modules*   | [sst](http://www.kamailio.org/docs/modules/4.0.x/modules/sst.html)                 |
| **remap_503_500 (boolean)**                 | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                   |
| **reminder (string)**                       | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)             |
| **remove_latency (integer)**                | *modules*   | [pike](http://www.kamailio.org/docs/modules/4.0.x/modules/pike.html)               |
| **renegotiation (boolean)**                 | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                 |
| **reparse_invite (integer)**                | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                   |
| **reparse_on_dns_failover (integer)**       | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                   |
| **reply_code (integer)**                    | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/pipelimit.html)     |
| **reply_dir (string)**                      | *modules*   | [mi_fifo](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_fifo.html)         |
| **reply_indent (string)**                   | *modules*   | [mi_datagram](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_datagram.html) |
| **reply_indent (string)**                   | *modules*   | [mi_fifo](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_fifo.html)         |
| **reply_option (integer)**                  | *modules*   | [mi_xmlrpc](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_xmlrpc.html)     |
| **reply_reason (string)**                   | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/pipelimit.html)     |
| **repl_exp_col (string)**                   | *modules*   | [dialplan](http://www.kamailio.org/docs/modules/4.0.x/modules/dialplan.html)       |
| **report_ack (integer)**                    | *modules*   | [acc](http://www.kamailio.org/docs/modules/4.0.x/modules/acc.html)                 |
| **report_cancels (integer)**                | *modules*   | [acc](http://www.kamailio.org/docs/modules/4.0.x/modules/acc.html)                 |
| **reqs_density_per_unit (integer)**         | *modules*   | [pike](http://www.kamailio.org/docs/modules/4.0.x/modules/pike.html)               |
| **request_uri_column (string)**             | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                 |
| **require_certificate (boolean)**           | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                 |
| **restart_fr_on_each_reply (integer)**      | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                   |
| **restore_dlg (int)**                       | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **restore_from_avp (string)**               | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **restore_mode (string)**                   | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **restore_passwd (string)**                 | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **restore_to_avp (string)**                 | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **retries (integer)**                       | *modules*   | [db_postgres](http://www.kamailio.org/docs/modules/4.0.x/modules/db_postgres.html) |
| **retry_after (integer)**                   | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)     |
| **retry_delay**                             | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                 |
| **retry_limit**                             | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                 |
| **retr_timer1 (integer)**                   | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                   |
| **retr_timer2 (integer)**                   | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                   |
| **re_exp_column (string)**                  | *modules*   | [group](http://www.kamailio.org/docs/modules/4.0.x/modules/group.html)             |
| **re_gid_column (string)**                  | *modules*   | [group](http://www.kamailio.org/docs/modules/4.0.x/modules/group.html)             |
| **re_table (string)**                       | *modules*   | [group](http://www.kamailio.org/docs/modules/4.0.x/modules/group.html)             |
| **ring_timeout (int)**                      | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.0.x/modules/siputils.html)       |
| **risk_group_column (string)**              | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html)       |
| **rlpres_clean_period (int)**               | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                 |
| **rlpres_db_url(str)**                      | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                 |
| **rlpres_table(str)**                       | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                 |
| **rlsubs_table(str)**                       | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                 |
| **rls_event (str)**                         | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                 |
| **rooms_table (str)**                       | *modules*   | [imc](http://www.kamailio.org/docs/modules/4.0.x/modules/imc.html)                 |
| **route (string)**                          | *modules*   | [xmlrpc](http://www.kamailio.org/docs/modules/4.0.x/modules/xmlrpc.html)           |
| **route_lir_user_unknown (string)**         | *modules*   | [ims_icscf](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_icscf.html)     |
| **route_uar_user_unknown (string)**         | *modules*   | [ims_icscf](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_icscf.html)     |
| **rpc_heartbeat_timeout (int)**             | *modules*   | [iptrtpproxy](http://www.kamailio.org/docs/modules/4.0.x/modules/iptrtpproxy.html) |
| **rpc_url (string)**                        | *modules*   | [mi_rpc](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_rpc.html)           |
| **rpid_avp (string)**                       | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.0.x/modules/siputils.html)       |
| **rpid_column (string)**                    | *modules*   | [uid_auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_auth_db.html) |
| **rpid_prefix (string)**                    | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.0.x/modules/siputils.html)       |
| **rpid_suffix (string)**                    | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.0.x/modules/siputils.html)       |
| **rr_from_store_param (string)**            | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **rr_param (string)**                       | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)           |
| **rr_param (string)**                       | *modules*   | [dialog_ng](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog_ng.html)     |
| **rr_to_store_param (string)**              | *modules*   | [uac](http://www.kamailio.org/docs/modules/4.0.x/modules/uac.html)                 |
| **rtpproxy_disable_tout (integer)**         | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.0.x/modules/rtpproxy.html)       |
| **rtpproxy_retr (integer)**                 | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.0.x/modules/rtpproxy.html)       |
| **rtpproxy_sock (string)**                  | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.0.x/modules/rtpproxy.html)       |
| **rtpproxy_tout (integer)**                 | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.0.x/modules/rtpproxy.html)       |
| **ruid_column (string)**                    | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)           |
| **rule_id_column (string)**                 | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                 |
| **ruri_avp (str)**                          | *modules*   | [drouting](http://www.kamailio.org/docs/modules/4.0.x/modules/drouting.html)       |
| **ruri_matching (integer)**                 | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                   |
| **ruri_user_avp (AVP string)**              | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                 |
| **rx_auth_expiry (integer)**                | *modules*   | [ims_qos](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_qos.html)         |
| **rx_dest_realm (string)**                  | *modules*   | [ims_qos](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_qos.html)         |
| **rx_forced_peer (string)**                 | *modules*   | [ims_qos](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_qos.html)         |

## \[S\]

| Name                                         | Module Path | Module Name                                                                              |
|----------------------------------------------|-------------|------------------------------------------------------------------------------------------|
| **sampling_time_unit (integer)**             | *modules*   | [pike](http://www.kamailio.org/docs/modules/4.0.x/modules/pike.html)                     |
| **sanity_checks (integer)**                  | *modules*   | [topoh](http://www.kamailio.org/docs/modules/4.0.x/modules/topoh.html)                   |
| **schema_path (string)**                     | *modules*   | [db_cassandra](http://www.kamailio.org/docs/modules/4.0.x/modules/db_cassandra.html)     |
| **scheme_column (string)**                   | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_avp_db.html)         |
| **script_cnt_grp_name**                      | *modules*   | [counters](http://www.kamailio.org/docs/modules/4.0.x/modules/counters.html)             |
| **script_counter**                           | *modules*   | [counters](http://www.kamailio.org/docs/modules/4.0.x/modules/counters.html)             |
| **script_name (string)**                     | *modules*   | [app_python](http://www.kamailio.org/docs/modules/4.0.x/modules/app_python.html)         |
| **scscf_entry_expiry (integer)**             | *modules*   | [ims_icscf](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_icscf.html)           |
| **sc_body (string)**                         | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_ctype (string)**                        | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_exp_time (string)**                     | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_from (string)**                         | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_inc_time (string)**                     | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_mid (string)**                          | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_snd_time (string)**                     | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_to (string)**                           | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_uri_host (string)**                     | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sc_uri_user (string)**                     | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **sdomain_column (string)**                  | *modules*   | [pdt](http://www.kamailio.org/docs/modules/4.0.x/modules/pdt.html)                       |
| **sd_domain_column (string)**                | *modules*   | [speeddial](http://www.kamailio.org/docs/modules/4.0.x/modules/speeddial.html)           |
| **sd_user_column (string)**                  | *modules*   | [speeddial](http://www.kamailio.org/docs/modules/4.0.x/modules/speeddial.html)           |
| **search_scope (string)**                    | *modules*   | [h350](http://www.kamailio.org/docs/modules/4.0.x/modules/h350.html)                     |
| **secret (string)**                          | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)                     |
| **send_bye (int)**                           | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                 |
| **send_close_notify (boolean)**              | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **send_fast_notify (int)**                   | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)             |
| **send_publish_flag (int)**                  | *modules*   | [pua_dialoginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_dialoginfo.html) |
| **send_socket_avp (string)**                 | *modules*   | [domainpolicy](http://www.kamailio.org/docs/modules/4.0.x/modules/domainpolicy.html)     |
| **send_time (int)**                          | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **send_timeout (int)**                       | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **separator (str)**                          | *modules*   | [tmrec](http://www.kamailio.org/docs/modules/4.0.x/modules/tmrec.html)                   |
| **server (str)**                             | *modules*   | [ndb_redis](http://www.kamailio.org/docs/modules/4.0.x/modules/ndb_redis.html)           |
| **server (string)**                          | *modules*   | [pdb](http://www.kamailio.org/docs/modules/4.0.x/modules/pdb.html)                       |
| **servers (str)**                            | *modules*   | [memcached](http://www.kamailio.org/docs/modules/4.0.x/modules/memcached.html)           |
| **servers (string)**                         | *modules*   | [jsonrpc-c](http://www.kamailio.org/docs/modules/4.0.x/modules/jsonrpc-c.html)           |
| **server_address (str)**                     | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)             |
| **server_address (str)**                     | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                       |
| **server_address(str)**                      | *modules*   | [pua_bla](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_bla.html)               |
| **server_address(str)**                      | *modules*   | [pua_reginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_reginfo.html)       |
| **server_address(str)**                      | *modules*   | [pua_xmpp](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_xmpp.html)             |
| **service_type (integer)**                   | *modules*   | [acc](http://www.kamailio.org/docs/modules/4.0.x/modules/acc.html)                       |
| **service_type (integer)**                   | *modules*   | [acc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/acc_radius.html)         |
| **service_type (integer)**                   | *modules*   | [auth_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_radius.html)       |
| **session_cache (boolean)**                  | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **session_id (str)**                         | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **setid_col (string)**                       | *modules*   | [dispatcher](http://www.kamailio.org/docs/modules/4.0.x/modules/dispatcher.html)         |
| **setid_pvname (str)**                       | *modules*   | [dispatcher](http://www.kamailio.org/docs/modules/4.0.x/modules/dispatcher.html)         |
| **setvars (integer)**                        | *modules*   | [exec](http://www.kamailio.org/docs/modules/4.0.x/modules/exec.html)                     |
| **sflags_column (string)**                   | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                 |
| **shvset (string)**                          | *modules*   | [pv](http://www.kamailio.org/docs/modules/4.0.x/modules/pv.html)                         |
| **sipEntityType (String)**                   | *modules*   | [snmpstats](http://www.kamailio.org/docs/modules/4.0.x/modules/snmpstats.html)           |
| **sipmsg (int)**                             | *modules*   | [msrp](http://www.kamailio.org/docs/modules/4.0.x/modules/msrp.html)                     |
| **sipping_bflag (integer)**                  | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)           |
| **sipping_from (string)**                    | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)           |
| **sipping_method (string)**                  | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.0.x/modules/nathelper.html)           |
| **sms_report_type (integer)**                | *modules*   | [sms](http://www.kamailio.org/docs/modules/4.0.x/modules/sms.html)                       |
| **snd_time_avp (str)**                       | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                   |
| **snmpCommunity (String)**                   | *modules*   | [snmpstats](http://www.kamailio.org/docs/modules/4.0.x/modules/snmpstats.html)           |
| **snmpgetPath (String)**                     | *modules*   | [snmpstats](http://www.kamailio.org/docs/modules/4.0.x/modules/snmpstats.html)           |
| **socket_column (string)**                   | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)                 |
| **socket_name (string)**                     | *modules*   | [mi_datagram](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_datagram.html)       |
| **socket_timeout (integer)**                 | *modules*   | [mi_datagram](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_datagram.html)       |
| **sock_flag (integer)**                      | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)           |
| **sock_hdr_name (string)**                   | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)           |
| **sort_order (int)**                         | *modules*   | [drouting](http://www.kamailio.org/docs/modules/4.0.x/modules/drouting.html)             |
| **source_col (string)**                      | *modules*   | [permissions](http://www.kamailio.org/docs/modules/4.0.x/modules/permissions.html)       |
| **source_networkid_avp**                     | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                       |
| **sp1_uri, sp2_uri, ..., sp16_uri**          | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                       |
| **sp1_weight, sp2_weight, ..., sp16_weight** | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                       |
| **spare_flag_column (string)**               | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html)             |
| **sqlcon (str)**                             | *modules*   | [sqlops](http://www.kamailio.org/docs/modules/4.0.x/modules/sqlops.html)                 |
| **sqlres (str)**                             | *modules*   | [sqlops](http://www.kamailio.org/docs/modules/4.0.x/modules/sqlops.html)                 |
| **ssl_free_list_max_len (integer)**          | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **ssl_lifetime**                             | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                       |
| **ssl_max_send_fragment (integer)**          | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **ssl_read_ahead (boolean)**                 | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **ssl_release_buffers (integer)**            | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                       |
| **sst_flag (integer)**                       | *modules*   | [sst](http://www.kamailio.org/docs/modules/4.0.x/modules/sst.html)                       |
| **start_time_column (string)**               | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                 |
| **state_column (string)**                    | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                 |
| **status_column (string)**                   | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html)             |
| **step_loops (int)**                         | *modules*   | [debugger](http://www.kamailio.org/docs/modules/4.0.x/modules/debugger.html)             |
| **step_usleep (int)**                        | *modules*   | [debugger](http://www.kamailio.org/docs/modules/4.0.x/modules/debugger.html)             |
| **stopper_column (string)**                  | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                       |
| **strip_column (string)**                    | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                       |
| **str_param (string)**                       | *modules*   | [print](http://www.kamailio.org/docs/modules/4.0.x/modules/print.html)                   |
| **subscriber_carrier_col (string)**          | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/4.0.x/modules/carrierroute.html)     |
| **subscriber_domain_col (string)**           | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/4.0.x/modules/carrierroute.html)     |
| **subscriber_domain_column (string)**        | *modules*   | [uid_uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_uri_db.html)         |
| **subscriber_table (string)**                | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/4.0.x/modules/carrierroute.html)     |
| **subscriber_table (string)**                | *modules*   | [uid_uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_uri_db.html)         |
| **subscriber_user_col (string)**             | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/4.0.x/modules/carrierroute.html)     |
| **subscriber_user_column (string)**          | *modules*   | [uid_uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_uri_db.html)         |
| **subst_exp_col (string)**                   | *modules*   | [dialplan](http://www.kamailio.org/docs/modules/4.0.x/modules/dialplan.html)             |
| **subs_db_mode (int)**                       | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)             |
| **subs_htable_size (int)**                   | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)             |
| **subs_table (str)**                         | *modules*   | [sca](http://www.kamailio.org/docs/modules/4.0.x/modules/sca.html)                       |
| **sub_protocols (integer)**                  | *modules*   | [websocket](http://www.kamailio.org/docs/modules/4.0.x/modules/websocket.html)           |
| **suffix (string)**                          | *modules*   | [diversion](http://www.kamailio.org/docs/modules/4.0.x/modules/diversion.html)           |
| **switchboard (string)**                     | *modules*   | [iptrtpproxy](http://www.kamailio.org/docs/modules/4.0.x/modules/iptrtpproxy.html)       |

## \[T\]

| Name                                    | Module Path | Module Name                                                                                  |
|-----------------------------------------|-------------|----------------------------------------------------------------------------------------------|
| **table (str)**                         | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **table (string)**                      | *modules*   | [group](http://www.kamailio.org/docs/modules/4.0.x/modules/group.html)                       |
| **table_name (str)**                    | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/4.0.x/modules/sipcapture.html)             |
| **table_name (string)**                 | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                     |
| **table_name (string)**                 | *modules*   | [dialog_ng](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog_ng.html)               |
| **table_name (string)**                 | *modules*   | [dialplan](http://www.kamailio.org/docs/modules/4.0.x/modules/dialplan.html)                 |
| **table_name (string)**                 | *modules*   | [dispatcher](http://www.kamailio.org/docs/modules/4.0.x/modules/dispatcher.html)             |
| **tag_avp (AVP string)**                | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                           |
| **tag_col (string)**                    | *modules*   | [permissions](http://www.kamailio.org/docs/modules/4.0.x/modules/permissions.html)           |
| **tag_column (string)**                 | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                           |
| **tel_uri_params (string)**             | *modules*   | [enum](http://www.kamailio.org/docs/modules/4.0.x/modules/enum.html)                         |
| **timeout (fixedpoint)**                | *modules*   | [db_oracle](http://www.kamailio.org/docs/modules/4.0.x/modules/db_oracle.html)               |
| **timeout (integer)**                   | *modules*   | [memcached](http://www.kamailio.org/docs/modules/4.0.x/modules/memcached.html)               |
| **timeout (integer)**                   | *modules*   | [pdb](http://www.kamailio.org/docs/modules/4.0.x/modules/pdb.html)                           |
| **timeout**                             | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                           |
| **timeout_avp (string)**                | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                     |
| **timeout_avp (string)**                | *modules*   | [dialog_ng](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog_ng.html)               |
| **timeout_avp (string)**                | *modules*   | [sst](http://www.kamailio.org/docs/modules/4.0.x/modules/sst.html)                           |
| **timeout_column (string)**             | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                     |
| **timeout_interval (integer)**          | *modules*   | [db_mysql](http://www.kamailio.org/docs/modules/4.0.x/modules/db_mysql.html)                 |
| **timeout_rm_subs (int)**               | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)                 |
| **timeout_socket (string)**             | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.0.x/modules/rtpproxy.html)                 |
| **timer (str)**                         | *modules*   | [rtimer](http://www.kamailio.org/docs/modules/4.0.x/modules/rtimer.html)                     |
| **timer_avp (string)**                  | *modules*   | [cpl-c](http://www.kamailio.org/docs/modules/4.0.x/modules/cpl-c.html)                       |
| **timer_interval (int)**                | *modules*   | [ims_usrloc_pcscf](http://www.kamailio.org/docs/modules/4.0.x/modules/ims_usrloc_pcscf.html) |
| **timer_interval (int)**                | *modules*   | [msrp](http://www.kamailio.org/docs/modules/4.0.x/modules/msrp.html)                         |
| **timer_interval (integer)**            | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.0.x/modules/htable.html)                     |
| **timer_interval (integer)**            | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/pipelimit.html)               |
| **timer_interval (integer)**            | *modules*   | [ratelimit](http://www.kamailio.org/docs/modules/4.0.x/modules/ratelimit.html)               |
| **timer_interval (integer)**            | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)                     |
| **timer_mode (integer)**                | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.0.x/modules/htable.html)                     |
| **timer_procs (string)**                | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)                     |
| **time_to_kill (integer)**              | *modules*   | [exec](http://www.kamailio.org/docs/modules/4.0.x/modules/exec.html)                         |
| **tls_debug (int)**                     | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                           |
| **tls_disable_compression (boolean)**   | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                           |
| **tls_force_run (boolean)**             | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                           |
| **tls_log (int)**                       | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                           |
| **tls_method (string)**                 | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)                           |
| **tname_column (string)**               | *modules*   | [mtree](http://www.kamailio.org/docs/modules/4.0.x/modules/mtree.html)                       |
| **token_format**                        | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                           |
| **toroute_column (string)**             | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                     |
| **to_presence_code (int)**              | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                           |
| **to_tag_column (string)**              | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                     |
| **to_tag_pref (str)**                   | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html)                 |
| **to_uri_column (string)**              | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)                     |
| **tprefix_column (string)**             | *modules*   | [mtree](http://www.kamailio.org/docs/modules/4.0.x/modules/mtree.html)                       |
| **traced_user_avp (str)**               | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **trace_delayed (integer)**             | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **trace_flag (integer)**                | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **trace_local_ip (str)**                | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **trace_on (integer)**                  | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **trace_sl_acks (integer)**             | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **trace_table_avp (str)**               | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **trace_to_database (integer)**         | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)                 |
| **transl_tbl (string) := "cfg_transl"** | *modules*   | [cfg_db](http://www.kamailio.org/docs/modules/4.0.x/modules/cfg_db.html)                     |
| **transport_column (string)**           | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                           |
| **transport_override_avp (string)**     | *modules*   | [domainpolicy](http://www.kamailio.org/docs/modules/4.0.x/modules/domainpolicy.html)         |
| **trusted_table (string)**              | *modules*   | [permissions](http://www.kamailio.org/docs/modules/4.0.x/modules/permissions.html)           |
| **tvalue_column (string)**              | *modules*   | [mtree](http://www.kamailio.org/docs/modules/4.0.x/modules/mtree.html)                       |
| **type_col (string)**                   | *modules*   | [domain](http://www.kamailio.org/docs/modules/4.0.x/modules/domain.html)                     |
| **type_column (string)**                | *modules*   | [avpops](http://www.kamailio.org/docs/modules/4.0.x/modules/avpops.html)                     |
| **type_column (string)**                | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_avp_db.html)             |

## \[U\]

| Name                                                       | Module Path | Module Name                                                                                        |
|------------------------------------------------------------|-------------|----------------------------------------------------------------------------------------------------|
| **uid_column (string)**                                    | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_avp_db.html)                   |
| **unix_socket_group (integer) unix_socket_group (string)** | *modules*   | [mi_datagram](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_datagram.html)                 |
| **unix_socket_mode (integer)**                             | *modules*   | [mi_datagram](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_datagram.html)                 |
| **unix_socket_user (integer) unix_socket_group (string)**  | *modules*   | [mi_datagram](http://www.kamailio.org/docs/modules/4.0.x/modules/mi_datagram.html)                 |
| **unix_tx_timeout (integer)**                              | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                                   |
| **unmatched_cancel (string)**                              | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                                   |
| **uparam_name (str)**                                      | *modules*   | [topoh](http://www.kamailio.org/docs/modules/4.0.x/modules/topoh.html)                             |
| **uparam_prefix (str)**                                    | *modules*   | [topoh](http://www.kamailio.org/docs/modules/4.0.x/modules/topoh.html)                             |
| **update_period (int)**                                    | *modules*   | [pua](http://www.kamailio.org/docs/modules/4.0.x/modules/pua.html)                                 |
| **uriuser_column (string)**                                | *modules*   | [uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uri_db.html)                           |
| **uri_attrs_table (string)**                               | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_avp_db.html)                   |
| **uri_checks (integer)**                                   | *modules*   | [sanity](http://www.kamailio.org/docs/modules/4.0.x/modules/sanity.html)                           |
| **uri_domain_column (string)**                             | *modules*   | [uid_uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_uri_db.html)                   |
| **uri_extra (string)**                                     | *modules*   | [misc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/misc_radius.html)                 |
| **uri_scheme_column (string)**                             | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)                                 |
| **uri_service_type (integer)**                             | *modules*   | [misc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/misc_radius.html)                 |
| **uri_table (string)**                                     | *modules*   | [uid_uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_uri_db.html)                   |
| **uri_uriuser_column (string)**                            | *modules*   | [uid_uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_uri_db.html)                   |
| **uri_user_column (string)**                               | *modules*   | [uid_uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_uri_db.html)                   |
| **url_column (string)**                                    | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html)                       |
| **url_match (str)**                                        | *modules*   | [xhttp](http://www.kamailio.org/docs/modules/4.0.x/modules/xhttp.html)                             |
| **url_match (str)**                                        | *modules*   | [xmlrpc](http://www.kamailio.org/docs/modules/4.0.x/modules/xmlrpc.html)                           |
| **url_skip (str)**                                         | *modules*   | [xhttp](http://www.kamailio.org/docs/modules/4.0.x/modules/xhttp.html)                             |
| **url_skip (str)**                                         | *modules*   | [xmlrpc](http://www.kamailio.org/docs/modules/4.0.x/modules/xmlrpc.html)                           |
| **user (integer or string)**                               | *modules*   | [ctl](http://www.kamailio.org/docs/modules/4.0.x/modules/ctl.html)                                 |
| **username_column (string)**                               | *modules*   | [avpops](http://www.kamailio.org/docs/modules/4.0.x/modules/avpops.html)                           |
| **username_column (string)**                               | *modules*   | [cpl-c](http://www.kamailio.org/docs/modules/4.0.x/modules/cpl-c.html)                             |
| **username_column (string)**                               | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_avp_db.html)                   |
| **user_agent_column (string)**                             | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)                           |
| **user_attrs_table (string)**                              | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_avp_db.html)                   |
| **user_column (str)**                                      | *modules*   | [alias_db](http://www.kamailio.org/docs/modules/4.0.x/modules/alias_db.html)                       |
| **user_column (string)**                                   | *modules*   | [auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_db.html)                         |
| **user_column (string)**                                   | *modules*   | [group](http://www.kamailio.org/docs/modules/4.0.x/modules/group.html)                             |
| **user_column (string)**                                   | *modules*   | [speeddial](http://www.kamailio.org/docs/modules/4.0.x/modules/speeddial.html)                     |
| **user_column (string)**                                   | *modules*   | [uid_auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_auth_db.html)                 |
| **user_column (string)**                                   | *modules*   | [uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uri_db.html)                           |
| **user_column (string)**                                   | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)                           |
| **use_contact (int)**                                      | *modules*   | [msilo](http://www.kamailio.org/docs/modules/4.0.x/modules/msilo.html)                             |
| **use_contact (integer)**                                  | *modules*   | [sms](http://www.kamailio.org/docs/modules/4.0.x/modules/sms.html)                                 |
| **use_default (int)**                                      | *modules*   | [dispatcher](http://www.kamailio.org/docs/modules/4.0.x/modules/dispatcher.html)                   |
| **use_domain (boolean)**                                   | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.0.x/modules/auth.html)                               |
| **use_domain (int)**                                       | *modules*   | [alias_db](http://www.kamailio.org/docs/modules/4.0.x/modules/alias_db.html)                       |
| **use_domain (int)**                                       | *modules*   | [auth_diameter](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_diameter.html)             |
| **use_domain (int)**                                       | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/4.0.x/modules/carrierroute.html)               |
| **use_domain (int)**                                       | *modules*   | [drouting](http://www.kamailio.org/docs/modules/4.0.x/modules/drouting.html)                       |
| **use_domain (int)**                                       | *modules*   | [speeddial](http://www.kamailio.org/docs/modules/4.0.x/modules/speeddial.html)                     |
| **use_domain (integer)**                                   | *modules*   | [auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_db.html)                         |
| **use_domain (integer)**                                   | *modules*   | [avpops](http://www.kamailio.org/docs/modules/4.0.x/modules/avpops.html)                           |
| **use_domain (integer)**                                   | *modules*   | [cpl-c](http://www.kamailio.org/docs/modules/4.0.x/modules/cpl-c.html)                             |
| **use_domain (integer)**                                   | *modules*   | [group](http://www.kamailio.org/docs/modules/4.0.x/modules/group.html)                             |
| **use_domain (integer)**                                   | *modules*   | [uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uri_db.html)                           |
| **use_domain (integer)**                                   | *modules*   | [userblacklist](http://www.kamailio.org/docs/modules/4.0.x/modules/userblacklist.html)             |
| **use_domain (integer)**                                   | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)                           |
| **use_escape_common (int)**                                | *modules*   | [db_unixodbc](http://www.kamailio.org/docs/modules/4.0.x/modules/db_unixodbc.html)                 |
| **use_partial_states (int)**                               | *modules*   | [presence_conference](http://www.kamailio.org/docs/modules/4.0.x/modules/presence_conference.html) |
| **use_path (integer)**                                     | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)                     |
| **use_path_addr (str)**                                    | *modules*   | [msrp](http://www.kamailio.org/docs/modules/4.0.x/modules/msrp.html)                               |
| **use_pubruri_avps (int)**                                 | *modules*   | [pua_dialoginfo](http://www.kamailio.org/docs/modules/4.0.x/modules/pua_dialoginfo.html)           |
| **use_received (int)**                                     | *modules*   | [path](http://www.kamailio.org/docs/modules/4.0.x/modules/path.html)                               |
| **use_rpid (integer)**                                     | *modules*   | [uid_auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_auth_db.html)                 |
| **use_rpid_for_calling_number**                            | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)                                 |
| **use_ruri_flag (integer)**                                | *modules*   | [auth_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_radius.html)                 |
| **use_sip_uri_host (integer)**                             | *modules*   | [misc_radius](http://www.kamailio.org/docs/modules/4.0.x/modules/misc_radius.html)                 |
| **use_uri_table (integer)**                                | *modules*   | [uri_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uri_db.html)                           |
| **uuid_column (string)**                                   | *modules*   | [avpops](http://www.kamailio.org/docs/modules/4.0.x/modules/avpops.html)                           |

## \[V\]

| Name                                          | Module Path | Module Name                                                                      |
|-----------------------------------------------|-------------|----------------------------------------------------------------------------------|
| **validate_call_id**                          | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.0.x/modules/osp.html)               |
| **value_col (string)**                        | *modules*   | [domain](http://www.kamailio.org/docs/modules/4.0.x/modules/domain.html)         |
| **value_column (string)**                     | *modules*   | [avpops](http://www.kamailio.org/docs/modules/4.0.x/modules/avpops.html)         |
| **value_column (string)**                     | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.0.x/modules/uid_avp_db.html) |
| **value_type_column (str)**                   | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.0.x/modules/htable.html)         |
| **variable (string)**                         | *modules*   | [statistics](http://www.kamailio.org/docs/modules/4.0.x/modules/statistics.html) |
| **varset (string)**                           | *modules*   | [pv](http://www.kamailio.org/docs/modules/4.0.x/modules/pv.html)                 |
| **vars_h\_entry_column (string)**             | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)         |
| **vars_h\_id_column (string)**                | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)         |
| **vars_key_column (string)**                  | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)         |
| **vars_table_name (string)**                  | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)         |
| **vars_value_column (string)**                | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)         |
| **verify_certificate (boolean)**              | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)               |
| **verify_depth (integer)**                    | *modules*   | [tls](http://www.kamailio.org/docs/modules/4.0.x/modules/tls.html)               |
| **verify_destination_service_type (integer)** | *modules*   | [peering](http://www.kamailio.org/docs/modules/4.0.x/modules/peering.html)       |
| **verify_source_service_type (integer)**      | *modules*   | [peering](http://www.kamailio.org/docs/modules/4.0.x/modules/peering.html)       |
| **version_table (integer)**                   | *modules*   | [auth_db](http://www.kamailio.org/docs/modules/4.0.x/modules/auth_db.html)       |
| **via1_matching (integer)**                   | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)                 |
| **vparam_name (str)**                         | *modules*   | [topoh](http://www.kamailio.org/docs/modules/4.0.x/modules/topoh.html)           |
| **vparam_prefix (str)**                       | *modules*   | [topoh](http://www.kamailio.org/docs/modules/4.0.x/modules/topoh.html)           |

## \[W\]

| Name                         | Module Path | Module Name                                                                  |
|------------------------------|-------------|------------------------------------------------------------------------------|
| **waitn_time (int)**         | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html) |
| **waitn_time (int)**         | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)           |
| **wait_ack (int)**           | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.0.x/modules/dialog.html)     |
| **watchers_table(str)**      | *modules*   | [presence](http://www.kamailio.org/docs/modules/4.0.x/modules/presence.html) |
| **weight_column (string)**   | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.0.x/modules/lcr.html)           |
| **workers (int)**            | *modules*   | [async](http://www.kamailio.org/docs/modules/4.0.x/modules/async.html)       |
| **write_db_url (string)**    | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html) |
| **write_on_db (int)**        | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html) |
| **write_on_master_db (int)** | *modules*   | [p_usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/p_usrloc.html) |
| **wt_timer (integer)**       | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.0.x/modules/tm.html)             |

## \[X\]

| Name                             | Module Path | Module Name                                                                          |
|----------------------------------|-------------|--------------------------------------------------------------------------------------|
| **xavp_cfg (string)**            | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)       |
| **xavp_contact (string)**        | *modules*   | [usrloc](http://www.kamailio.org/docs/modules/4.0.x/modules/usrloc.html)             |
| **xavp_rcd (string)**            | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.0.x/modules/registrar.html)       |
| **xcapauth_userdel_reason(str)** | *modules*   | [presence_xml](http://www.kamailio.org/docs/modules/4.0.x/modules/presence_xml.html) |
| **xcap_db_url(str)**             | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                   |
| **xcap_root (str)**              | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                   |
| **xcap_root (str)**              | *modules*   | [xcap_server](http://www.kamailio.org/docs/modules/4.0.x/modules/xcap_server.html)   |
| **xcap_server (str)**            | *modules*   | [presence_xml](http://www.kamailio.org/docs/modules/4.0.x/modules/presence_xml.html) |
| **xcap_table (string)**          | *modules*   | [utils](http://www.kamailio.org/docs/modules/4.0.x/modules/utils.html)               |
| **xcap_table (string)**          | *modules*   | [xcap_server](http://www.kamailio.org/docs/modules/4.0.x/modules/xcap_server.html)   |
| **xcap_table(str)**              | *modules*   | [presence_xml](http://www.kamailio.org/docs/modules/4.0.x/modules/presence_xml.html) |
| **xcap_table(str)**              | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.0.x/modules/rls.html)                   |
| **xcap_table(str)**              | *modules*   | [xcap_client](http://www.kamailio.org/docs/modules/4.0.x/modules/xcap_client.html)   |
| **xheaders_read (integer)**      | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)         |
| **xheaders_write (integer)**     | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.0.x/modules/siptrace.html)         |
| **xhttp_pi_buf_size (int)**      | *modules*   | [xhttp_pi](http://www.kamailio.org/docs/modules/4.0.x/modules/xhttp_pi.html)         |
| **xhttp_pi_root (str)**          | *modules*   | [xhttp_pi](http://www.kamailio.org/docs/modules/4.0.x/modules/xhttp_pi.html)         |
| **xhttp_rpc_buf_size (str)**     | *modules*   | [xhttp_rpc](http://www.kamailio.org/docs/modules/4.0.x/modules/xhttp_rpc.html)       |
| **xhttp_rpc_root (str)**         | *modules*   | [xhttp_rpc](http://www.kamailio.org/docs/modules/4.0.x/modules/xhttp_rpc.html)       |
| **xlbuf_size (integer)**         | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.0.x/modules/avp.html)                   |
| **xml_ns (str)**                 | *modules*   | [xcap_server](http://www.kamailio.org/docs/modules/4.0.x/modules/xcap_server.html)   |
| **xmpp_domain (string)**         | *modules*   | [xmpp](http://www.kamailio.org/docs/modules/4.0.x/modules/xmpp.html)                 |
| **xmpp_host (string)**           | *modules*   | [xmpp](http://www.kamailio.org/docs/modules/4.0.x/modules/xmpp.html)                 |
| **xmpp_password (string)**       | *modules*   | [xmpp](http://www.kamailio.org/docs/modules/4.0.x/modules/xmpp.html)                 |
| **xmpp_port (integer)**          | *modules*   | [xmpp](http://www.kamailio.org/docs/modules/4.0.x/modules/xmpp.html)                 |
