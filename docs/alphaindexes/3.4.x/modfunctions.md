...
| **allow_routing()**                                  | *modules_k* | [permissions](http://www.kamailio.org/docs/modules/3.4.x/modules_k/permissions.html)   |
...
| **auth_add_identity()**                              | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/3.4.x/modules/auth_identity.html) |
...
| **cpl_run_script(type,mode)**                                                                 | *modules_k* | [cpl-c](http://www.kamailio.org/docs/modules/3.4.x/modules_k/cpl-c.html)                 |
...
| **ds_is_from_list(\[groupid\])**                 | *modules_k* | [dispatcher](http://www.kamailio.org/docs/modules/3.4.x/modules_k/dispatcher.html)       |
...
| **from_any_gw(\[ip_addr, proto\])**       | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.4.x/modules/lcr.html)               |
...
| **is_direction(dir)**                                                            | *modules_k* | [rr](http://www.kamailio.org/docs/modules/3.4.x/modules_k/rr.html)                   |
...
| **is_rfc1918(ip_address)**                                                       | *modules_k* | [nathelper](http://www.kamailio.org/docs/modules/3.4.x/modules_k/nathelper.html)     |
...
| **loose_route()**                                                         | *modules_k* | [rr](http://www.kamailio.org/docs/modules/3.4.x/modules_k/rr.html)               |
...
| **pres_refresh_watchers(uri, event, type\[, file_uri, filename\])** | *modules_k* | [presence](http://www.kamailio.org/docs/modules/3.4.x/modules_k/presence.html)         |
...
| **rand_event()**                                 | *modules_k* | [cfgutils](http://www.kamailio.org/docs/modules/3.4.x/modules_k/cfgutils.html)       |
...
| **resetsflag(flag \[, branch\])**                | *modules_k* | [kex](http://www.kamailio.org/docs/modules/3.4.x/modules_k/kex.html)                 |
...
| **sdp_with_codecs_by_name(list)**                 | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/3.4.x/modules/sdpops.html)               |
...
| **sl_send_reply(code, reason)**                   | *modules*   | [sl](http://www.kamailio.org/docs/modules/3.4.x/modules/sl.html)                       |
...
| **t_flush_flags()**                                   | *modules_k* | [tmx](http://www.kamailio.org/docs/modules/3.4.x/modules_k/tmx.html)           |
...
| **t_on_failure(failure_route)**                       | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_on_reply(onreply_route)**                         | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_relay(\[host, port\])**                           | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_relay_cancel()**                                  | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_relay_to(proxy, flags)**                          | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_relay_to_sctp(\[ip, port\])**                     | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_relay_to_tcp(\[ip, port\])**                      | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_relay_to_tls(\[ip, port\])**                      | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_relay_to_udp(\[ip, port\])**                      | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_release()**                                       | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_replicate(params)**                               | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_reply(code, reason_phrase)**                      | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_reply_callid(callid, cseq, code, reason)**        | *modules_k* | [tmx](http://www.kamailio.org/docs/modules/3.4.x/modules_k/tmx.html)           |
| **t_reset_fr()**                                      | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_reset_max_lifetime()**                            | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_reset_retr()**                                    | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_retransmit_reply()**                              | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_save_lumps()**                                    | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_set_auto_inv_100(0\|1)**                          | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_set_disable_6xx(0\|1)**                           | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_set_disable_failover(0\|1)**                      | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_set_fr(fr_inv_timeout \[, fr_timeout\])**         | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_set_max_lifetime(inv_lifetime, noninv_lifetime)** | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_set_no_e2e_cancel_reason(0\|1)**                  | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_set_retr(retr_t1_interval, retr_t2_interval)**    | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.4.x/modules/tm.html)               |
| **t_suspend()**                                       | *modules_k* | [tmx](http://www.kamailio.org/docs/modules/3.4.x/modules_k/tmx.html)           |

## \[U\]

| Name                                     | Module Path | Module Name                                                                        |
|------------------------------------------|-------------|------------------------------------------------------------------------------------|
| **uac_auth()**                           | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_auth()**                           | *modules_s* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_s/uac.html)               |
| **uac_reg_lookup(uuid, dst)**            | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_reg_request_to(user, mode)**       | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_replace_from(display,uri)**        | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_replace_from(display,uri)**        | *modules_s* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_s/uac.html)               |
| **uac_replace_from(uri)**                | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_replace_from(uri)**                | *modules_s* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_s/uac.html)               |
| **uac_replace_to(display,uri)**          | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_replace_to(uri)**                  | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_req_send()**                       | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_restore_from()**                   | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **uac_restore_from()**                   | *modules_s* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_s/uac.html)               |
| **uac_restore_to()**                     | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.4.x/modules_k/uac.html)               |
| **unforce_rtp_proxy()**                  | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/3.4.x/modules/rtpproxy.html)       |
| **unlock(key)**                          | *modules_k* | [cfgutils](http://www.kamailio.org/docs/modules/3.4.x/modules_k/cfgutils.html)     |
| **unlock_extra_attrs (group_id, id)**    | *modules_s* | [avp_db](http://www.kamailio.org/docs/modules/3.4.x/modules_s/avp_db.html)         |
| **unregister(domain, uri)**              | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.4.x/modules_k/registrar.html)   |
| **unset_dlg_profile(profile,\[value\])** | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.4.x/modules_k/dialog.html)         |
| **update_stat(variable,value)**          | *modules_k* | [statistics](http://www.kamailio.org/docs/modules/3.4.x/modules_k/statistics.html) |
| **uri_param(param)**                     | *modules_k* | [siputils](http://www.kamailio.org/docs/modules/3.4.x/modules_k/siputils.html)     |
| **uri_param(param,value)**               | *modules_k* | [siputils](http://www.kamailio.org/docs/modules/3.4.x/modules_k/siputils.html)     |
| **use_media_proxy()**                    | *modules*   | [mediaproxy](http://www.kamailio.org/docs/modules/3.4.x/modules/mediaproxy.html)   |
| **use_next_gw()/next_routing()**         | *modules_k* | [drouting](http://www.kamailio.org/docs/modules/3.4.x/modules_k/drouting.html)     |
| **usleep(time)**                         | *modules_k* | [cfgutils](http://www.kamailio.org/docs/modules/3.4.x/modules_k/cfgutils.html)     |

## \[V\]

| Name                         | Module Path | Module Name                                                                            |
|------------------------------|-------------|----------------------------------------------------------------------------------------|
| **validateospheader()**      | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.4.x/modules_k/osp.html)                   |
| **verify_destination()**     | *modules*   | [peering](http://www.kamailio.org/docs/modules/3.4.x/modules/peering.html)             |
| **verify_source()**          | *modules*   | [peering](http://www.kamailio.org/docs/modules/3.4.x/modules/peering.html)             |
| **vrfy_check_callid()**      | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/3.4.x/modules/auth_identity.html) |
| **vrfy_check_certificate()** | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/3.4.x/modules/auth_identity.html) |
| **vrfy_check_date()**        | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/3.4.x/modules/auth_identity.html) |
| **vrfy_check_msgvalidity()** | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/3.4.x/modules/auth_identity.html) |
| **vrfy_get_certificate()**   | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/3.4.x/modules/auth_identity.html) |

## \[W\]

| Name                               | Module Path | Module Name                                                                    |
|------------------------------------|-------------|--------------------------------------------------------------------------------|
| **ws_handle_handshake()**          | *modules*   | [websocket](http://www.kamailio.org/docs/modules/3.4.x/modules/websocket.html) |
| **www_authenticate(realm, table)** | *modules_k* | [auth_db](http://www.kamailio.org/docs/modules/3.4.x/modules_k/auth_db.html)   |
| **www_authorize(realm, table)**    | *modules_k* | [auth_db](http://www.kamailio.org/docs/modules/3.4.x/modules_k/auth_db.html)   |
| **www_authorize(realm, table)**    | *modules_s* | [auth_db](http://www.kamailio.org/docs/modules/3.4.x/modules_s/auth_db.html)   |
| **www_challenge(realm, flags)**    | *modules*   | [auth](http://www.kamailio.org/docs/modules/3.4.x/modules/auth.html)           |

## \[X\]

| Name                                              | Module Path | Module Name                                                                          |
|---------------------------------------------------|-------------|--------------------------------------------------------------------------------------|
| **xcaps_del(uri, path)**                          | *modules_k* | [xcap_server](http://www.kamailio.org/docs/modules/3.4.x/modules_k/xcap_server.html) |
| **xcaps_get(uri, path)**                          | *modules_k* | [xcap_server](http://www.kamailio.org/docs/modules/3.4.x/modules_k/xcap_server.html) |
| **xcaps_put(uri, path, doc)**                     | *modules_k* | [xcap_server](http://www.kamailio.org/docs/modules/3.4.x/modules_k/xcap_server.html) |
| **xcap_auth_status(watcher_uri, presentity_uri)** | *modules*   | [utils](http://www.kamailio.org/docs/modules/3.4.x/modules/utils.html)               |
| **xdbg(format)**                                  | *modules_k* | [xlog](http://www.kamailio.org/docs/modules/3.4.x/modules_k/xlog.html)               |
| **xdbg(format)**                                  | *modules_s* | [xlog](http://www.kamailio.org/docs/modules/3.4.x/modules_s/xlog.html)               |
| **xdbgl(format)**                                 | *modules_k* | [xlog](http://www.kamailio.org/docs/modules/3.4.x/modules_k/xlog.html)               |
| **xhttp_reply(code, reason, ctype, body)**        | *modules*   | [xhttp](http://www.kamailio.org/docs/modules/3.4.x/modules/xhttp.html)               |
| **xlfix_attr($attribute)**                        | *modules_s* | [avp](http://www.kamailio.org/docs/modules/3.4.x/modules_s/avp.html)                 |
| **xlog(level, format)**                           | *modules_s* | [xlog](http://www.kamailio.org/docs/modules/3.4.x/modules_s/xlog.html)               |
| **xlog(\[ \[facility,\] level,\] format)**        | *modules_k* | [xlog](http://www.kamailio.org/docs/modules/3.4.x/modules_k/xlog.html)               |
| **xlogl(\[ \[facility,\] level,\] format)**       | *modules_k* | [xlog](http://www.kamailio.org/docs/modules/3.4.x/modules_k/xlog.html)               |
| **xlset_attr($attribute, xl_format)**             | *modules_s* | [avp](http://www.kamailio.org/docs/modules/3.4.x/modules_s/avp.html)                 |
| **xlset_destination(xl_format)**                  | *modules_s* | [avp](http://www.kamailio.org/docs/modules/3.4.x/modules_s/avp.html)                 |
| **xmlrpc_reply(code, reason)**                    | *modules*   | [xmlrpc](http://www.kamailio.org/docs/modules/3.4.x/modules/xmlrpc.html)             |
| **xmpp_send_message()**                           | *modules_k* | [xmpp](http://www.kamailio.org/docs/modules/3.4.x/modules_k/xmpp.html)               |
