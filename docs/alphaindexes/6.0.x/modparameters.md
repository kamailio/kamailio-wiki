...
| **capture_node (str)** | [sipcapture](https://www.kamailio.org/docs/modules/6.0.x/modules/sipcapture.html#sipcapture.p.capture_node) |
...
| **db_url (string)** | [cplc](https://www.kamailio.org/docs/modules/6.0.x/modules/cplc.html#cplc.p.db_url) |
...
| **enable_full_lr (integer)** | [rr](https://www.kamailio.org/docs/modules/6.0.x/modules/rr.html#rr.p.enable_full_lr) |
| **enable_keepalive (int)** | [drouting](https://www.kamailio.org/docs/modules/6.0.x/modules/drouting.html#drouting.p.enable_keepalive) |
| **enable_r2 (int)** | [path](https://www.kamailio.org/docs/modules/6.0.x/modules/path.html#path.p.enable_r2) |
| **enable_socket_mismatch_warning (integer)** | [rr](https://www.kamailio.org/docs/modules/6.0.x/modules/rr.html#rr.p.enable_socket_warning) |
| **enable_sphere_check (int)** | [presence](https://www.kamailio.org/docs/modules/6.0.x/modules/presence.html#presence.p.enable_sphere_check) |
...
| **engine (string)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.engine) |
| **engine_algorithms (string)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.engine_algorithms) |
| **engine_config (string)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.engine_config) |
| **entity_prefix (str)** | [pua_usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/pua_usrloc.html) |
| **erlang_nodename (str)** | [erlang](https://www.kamailio.org/docs/modules/6.0.x/modules/erlang.html#erlang.p.erlang_nodename) |
| **error_column (string)** | [p_usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/p_usrloc.html) |
| **error_reply_code (int)** | [ims_registrar_scscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_registrar_scscf.html) |
| **escape_cr (integer)** | [xmlrpc](https://www.kamailio.org/docs/modules/6.0.x/modules/xmlrpc.html#xmlrpc.p.escape_cr) |
| **evcb_msg (str)** | [siptrace](https://www.kamailio.org/docs/modules/6.0.x/modules/siptrace.html#siptrace.p.evcb_msg) |
| **evcb_reply_out (string)** | [corex](https://www.kamailio.org/docs/modules/6.0.x/modules/corex.html#corex.p.evcb_reply_out) |
| **event_callback (str)** | [dialog](https://www.kamailio.org/docs/modules/6.0.x/modules/dialog.html#dialog.p.event_callback) |
...
| **event_callback (str)** | [tcpops](https://www.kamailio.org/docs/modules/6.0.x/modules/tcpops.html#tcpops.p.event_callback) |
| **event_callback (str)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.event_callback) |
| **event_callback (str)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.event_callback) |
| **event_callback (str)** | [topoh](https://www.kamailio.org/docs/modules/6.0.x/modules/topoh.html#topoh.p.event_callback) |
| **event_callback (str)** | [topos](https://www.kamailio.org/docs/modules/6.0.x/modules/topos.html#topos.p.event_callback) |
| **event_callback (str)** | [uac](https://www.kamailio.org/docs/modules/6.0.x/modules/uac.html#uac.p.event_callback) |
...
| **exec (str)** | [evrexec](https://www.kamailio.org/docs/modules/6.0.x/modules/evrexec.html) |
| **exec (str)** | [rtimer](https://www.kamailio.org/docs/modules/6.0.x/modules/rtimer.html) |
| **exec_time_check (int)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.exec_time_check) |
| **exit (int)** | [prefix_route](https://www.kamailio.org/docs/modules/6.0.x/modules/prefix_route.html#prefixroute.exit) |
...
| **extra_hdrs_avp (str)** | [msilo](https://www.kamailio.org/docs/modules/6.0.x/modules/msilo.html#msilo.p.extra_hdrs_avp) |
| **extra_id_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.extra_id_pv) |
| **extra_id_pv (string)** | [rtpproxy](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpproxy.html#rtpproxy.p.extra_id_pv) |

## [f]

| Name | Module Name |
|------|-------------|
| **fage (int)** | [sipdump](https://www.kamailio.org/docs/modules/6.0.x/modules/sipdump.html#sipdump.p.fage) |
| **failed_filter (string)** | [acc](https://www.kamailio.org/docs/modules/6.0.x/modules/acc.html#acc.p.failed_filter) |
| **failed_transaction_flag (integer)** | [acc](https://www.kamailio.org/docs/modules/6.0.x/modules/acc.html#acc.p.failed_transaction_flag) |
| **failover_level (int)** | [p_usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/p_usrloc.html) |
| **failover_reply_codes (string)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.failover_reply_codes) |
| **failover_time_column (string)** | [p_usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/p_usrloc.html) |
| **failure_exec_mode (boolean)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.failure_exec_mode) |
| **failure_reply_mode (integer)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.failure_reply_mode) |
| **faked_reply_prio (integer)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#faked_reply_prio) |
| **fallback_default (int)** | [carrierroute](https://www.kamailio.org/docs/modules/6.0.x/modules/carrierroute.html) |
| **fetch_rows (int)** | [dialplan](https://www.kamailio.org/docs/modules/6.0.x/modules/dialplan.html#dialplan.p.fetch_rows) |
| **fetch_rows (int)** | [drouting](https://www.kamailio.org/docs/modules/6.0.x/modules/drouting.html#drouting.p.fetch_rows) |
| **fetch_rows (int)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.fetch_rows) |
| **fetch_rows (integer)** | [carrierroute](https://www.kamailio.org/docs/modules/6.0.x/modules/carrierroute.html) |
| **fetch_rows (integer)** | [htable](https://www.kamailio.org/docs/modules/6.0.x/modules/htable.html#htable.p.fetch_rows) |
| **fetch_rows (integer)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.fetch_rows) |
| **fetch_rows (integer)** | [mtree](https://www.kamailio.org/docs/modules/6.0.x/modules/mtree.html#mtree.p.fetch_rows) |
| **fetch_rows (integer)** | [pdt](https://www.kamailio.org/docs/modules/6.0.x/modules/pdt.html) |
| **fetch_rows (integer)** | [presence](https://www.kamailio.org/docs/modules/6.0.x/modules/presence.html#presence.p.fetch_rows) |
| **fetch_rows (integer)** | [pua](https://www.kamailio.org/docs/modules/6.0.x/modules/pua.html) |
| **fetch_rows (integer)** | [rls](https://www.kamailio.org/docs/modules/6.0.x/modules/rls.html#rls.p.fetch_rows) |
| **fetch_rows(int)** | [ims_usrloc_scscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_usrloc_scscf.html#ims_usrloc_scscf.p.fetch_rows) |
| **fifo (integer)** | [ctl](https://www.kamailio.org/docs/modules/6.0.x/modules/ctl.html#fifo) |
| **fifo_group (int or str)** | [jsonrpcs](https://www.kamailio.org/docs/modules/6.0.x/modules/jsonrpcs.html#jsonrpcs.p.fifo_group) |
| **fifo_mode (int)** | [jsonrpcs](https://www.kamailio.org/docs/modules/6.0.x/modules/jsonrpcs.html#jsonrpcs.p.fifo_mode) |
...
| **flags_avp (AVP string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.flags_avp) |
| **flags_col (string)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.flags_col) |
| **flags_col (string)** | [uid_domain](https://www.kamailio.org/docs/modules/6.0.x/modules/uid_domain.html#domain.flags_col) |
| **flags_column (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html) |
...
| **flush (integer)** | [db_flatstore](https://www.kamailio.org/docs/modules/6.0.x/modules/db_flatstore.html#flush) |
| **flush_on_reconnect (integer)** | [ndb_redis](https://www.kamailio.org/docs/modules/6.0.x/modules/ndb_redis.html#ndb_redis.p.flush_on_reconnect) |
| **folder (str)** | [sipdump](https://www.kamailio.org/docs/modules/6.0.x/modules/sipdump.html#sipdump.p.folder) |
| **force_active (int)** | [presence_xml](https://www.kamailio.org/docs/modules/6.0.x/modules/presence_xml.html#presence_xml.p.force_active) |
| **force_cmd_exec (int)** | [app_java](https://www.kamailio.org/docs/modules/6.0.x/modules/app_java.html#app_java.p.force_cmd_exec) |
| **force_color (integer)** | [xlog](https://www.kamailio.org/docs/modules/6.0.x/modules/xlog.html#xlog.p.force_color) |
| **force_delete (int)** | [presence](https://www.kamailio.org/docs/modules/6.0.x/modules/presence.html#presence.p.force_delete) |
| **force_dns (int)** | [drouting](https://www.kamailio.org/docs/modules/6.0.x/modules/drouting.html#drouting.p.force_dns) |
| **force_dst (int)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.force_dst) |
| **force_dummy_dialog (int)** | [presence_dialoginfo](https://www.kamailio.org/docs/modules/6.0.x/modules/presence_dialoginfo.html) |
| **force_dummy_presence(int)** | [presence_xml](https://www.kamailio.org/docs/modules/6.0.x/modules/presence_xml.html#presence_xml.p.force_dummy_presence) |
| **force_generate_avps (integer)** | [auth_db](https://www.kamailio.org/docs/modules/6.0.x/modules/auth_db.html#auth_db.p.force_generate_avps) |
| **force_icscf_uri (string)** | [ims_registrar_pcscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_registrar_pcscf.html) |
| **force_no_outbound_flag (integer)** | [outbound](https://www.kamailio.org/docs/modules/6.0.x/modules/outbound.html) |
| **force_outbound_flag (integer)** | [outbound](https://www.kamailio.org/docs/modules/6.0.x/modules/outbound.html) |
| **force_presence_single_body(int)** | [presence_xml](https://www.kamailio.org/docs/modules/6.0.x/modules/presence_xml.html#presence_xml.p.force_presence_single_body) |
| **force_send_interface (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.force_send_interface) |
| **force_send_sock (str)** | [siptrace](https://www.kamailio.org/docs/modules/6.0.x/modules/siptrace.html#siptrace.p.force_send_sock) |
| **force_send_socket (int)** | [rr](https://www.kamailio.org/docs/modules/6.0.x/modules/rr.html#rr.p.force_send_socket) |
| **force_single_dialog (int)** | [presence_dialoginfo](https://www.kamailio.org/docs/modules/6.0.x/modules/presence_dialoginfo.html) |
| **force_socket (string)** | [nathelper](https://www.kamailio.org/docs/modules/6.0.x/modules/nathelper.html#nathelper.p.force_socket) |
...
| **from_contact_column (string)** | [dialog](https://www.kamailio.org/docs/modules/6.0.x/modules/dialog.html#dialog.p.from_contact_column) |
| **from_cseq_column (string)** | [dialog](https://www.kamailio.org/docs/modules/6.0.x/modules/dialog.html#dialog.p.from_cseq_column) |
...
| Name | Module Name |
|------|-------------|
| **gateway_domain (string)** | [xmpp](https://www.kamailio.org/docs/modules/6.0.x/modules/xmpp.html) |
| **general_query_flags (integer)** | [dnssec](https://www.kamailio.org/docs/modules/6.0.x/modules/dnssec.html) |
| **geoheader_order (int)** | [lost](https://www.kamailio.org/docs/modules/6.0.x/modules/lost.html#lost.p.geoheader_order) |
| **geoheader_type (int)** | [lost](https://www.kamailio.org/docs/modules/6.0.x/modules/lost.html#lost.p.geoheader_type) |
| **globalblocklist_allowlist_col (string)** | [userblocklist](https://www.kamailio.org/docs/modules/6.0.x/modules/userblocklist.html) |
| **globalblocklist_description_col (string)** | [userblocklist](https://www.kamailio.org/docs/modules/6.0.x/modules/userblocklist.html) |
| **globalblocklist_id_col (string)** | [userblocklist](https://www.kamailio.org/docs/modules/6.0.x/modules/userblocklist.html) |
| **globalblocklist_prefix_col (string)** | [userblocklist](https://www.kamailio.org/docs/modules/6.0.x/modules/userblocklist.html) |
| **globalblocklist_table (String)** | [userblocklist](https://www.kamailio.org/docs/modules/6.0.x/modules/userblocklist.html) |
| **granularity (int)** | [benchmark](https://www.kamailio.org/docs/modules/6.0.x/modules/benchmark.html) |
| **group (integer or string)** | [ctl](https://www.kamailio.org/docs/modules/6.0.x/modules/ctl.html#group) |
| **group_column (string)** | [group](https://www.kamailio.org/docs/modules/6.0.x/modules/group.html#group.p.group_column) |
| **group_extra (string)** | [misc_radius](https://www.kamailio.org/docs/modules/6.0.x/modules/misc_radius.html#mrad.p.group_extra) |
| **group_max_size (int)** | [regex](https://www.kamailio.org/docs/modules/6.0.x/modules/regex.html#regex.p.group_max_size) |
...
| **hep_version (integer)** | [siptrace](https://www.kamailio.org/docs/modules/6.0.x/modules/siptrace.html#siptrace.p.hep_version) |
| **host (str)** | [mqtt](https://www.kamailio.org/docs/modules/6.0.x/modules/mqtt.html#mqtt.p.host) |
...
| **http_reuse (int)** | [ruxc](https://www.kamailio.org/docs/modules/6.0.x/modules/ruxc.html#ruxc.p.http_reuse) |
| **http_timeout (int)** | [ruxc](https://www.kamailio.org/docs/modules/6.0.x/modules/ruxc.html#ruxc.p.http_timeout) |
| **http_timeout_connect (int)** | [ruxc](https://www.kamailio.org/docs/modules/6.0.x/modules/ruxc.html#ruxc.p.http_timeout_connect) |
...
| **instance_column (string)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.instance_column) |
| **integrated_xcap_server (int)** | [presence_xml](https://www.kamailio.org/docs/modules/6.0.x/modules/presence_xml.html#presence_xml.p.integrated_xcap_server) |
...
| **ipsec_reuse_server_port (int)** | [ims_ipsec_pcscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_ipsec_pcscf.html) |
...
| Name | Module Name |
|------|-------------|
| **java_options (string)** | [app_java](https://www.kamailio.org/docs/modules/6.0.x/modules/app_java.html#app_java.p.java_option) |
| **journal_roll_interval (integer seconds)** | [db_berkeley](https://www.kamailio.org/docs/modules/6.0.x/modules/db_berkeley.html) |

## [k]

| Name | Module Name |
|------|-------------|
| **ka_domain (str)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.ka_domain) |
| **ka_failed_limit (int)** | [dialog](https://www.kamailio.org/docs/modules/6.0.x/modules/dialog.html#dialog.p.ka_failed_limit) |
...
| **keepalive_mechanism (integer)** | [websocket](https://www.kamailio.org/docs/modules/6.0.x/modules/websocket.html#websocket.p.keepalive_mechanism) |
...
| Name | Module Name |
|------|-------------|
| **latency_threshold (int)** | [cdp](https://www.kamailio.org/docs/modules/6.0.x/modules/cdp.html) |
| **lcr_count (integer)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.lcr_count) |
| **lcr_gw_count (integer)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.lcr_gw_count) |
| **lcr_gw_table (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.lcr_gw_table) |
| **lcr_id_avp (AVP string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.lcr_id_avp) |
| **lcr_id_column (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html) |
| **lcr_rule_hash_size (integer)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.lcr_rule_hash_size) |
| **lcr_rule_table (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.lcr_rule_table) |
| **lcr_rule_target_table (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.lcr_rule_target_table) |
| **ldap_session (string)** | [h350](https://www.kamailio.org/docs/modules/6.0.x/modules/h350.html) |
| **libopt (str)** | [secsipid](https://www.kamailio.org/docs/modules/6.0.x/modules/secsipid.html#secsipid.p.libopt) |
...
| **load_fetch (integer)** | [pipelimit](https://www.kamailio.org/docs/modules/6.0.x/modules/pipelimit.html#pipelimit.p.load_fetch) |
| **load_rank (int)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.load_rank) |
| **local_ack_mode (integer)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.local_ack_mode) |
| **local_cancel_reason (boolean)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#local_cancel_reason) |
...
| **log_extra (string)** | [acc](https://www.kamailio.org/docs/modules/6.0.x/modules/acc.html#acc.p.log_extra) |
| **log_facility (str)** | [debugger](https://www.kamailio.org/docs/modules/6.0.x/modules/debugger.html#dbg.p.log_facility) |
| **log_facility (string)** | [acc](https://www.kamailio.org/docs/modules/6.0.x/modules/acc.html#acc.p.log_facility) |
| **log_facility (string)** | [xlog](https://www.kamailio.org/docs/modules/6.0.x/modules/xlog.html#xlog.p.log_facility) |
| **log_file_name (string)** | [rtp_media_server](https://www.kamailio.org/docs/modules/6.0.x/modules/rtp_media_server.html) |
| **log_flag (integer)** | [acc](https://www.kamailio.org/docs/modules/6.0.x/modules/acc.html#acc.p.log_flag) |
| **log_level (int)** | [debugger](https://www.kamailio.org/docs/modules/6.0.x/modules/debugger.html#dbg.p.log_level) |
| **log_level (integer)** | [acc](https://www.kamailio.org/docs/modules/6.0.x/modules/acc.html#acc.p.log_level) |
| **log_level_name (str)** | [debugger](https://www.kamailio.org/docs/modules/6.0.x/modules/debugger.html#dbg.p.log_level_name) |
...
| Name | Module Name |
|------|-------------|
| **mask (int)** | [cfgt](https://www.kamailio.org/docs/modules/6.0.x/modules/cfgt.html#cfgt.p.mask) |
| **mask_callid (int)** | [topos](https://www.kamailio.org/docs/modules/6.0.x/modules/topos.html#topos.p.mask_callid) |
| **mask_callid (integer)** | [topoh](https://www.kamailio.org/docs/modules/6.0.x/modules/topoh.html#topoh.p.mask_callid) |
...
| **match_len_col (string)** | [dialplan](https://www.kamailio.org/docs/modules/6.0.x/modules/dialplan.html#dialplan.p.match_len_col) |
...
| **max_noninv_lifetime (integer)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#max_noninv_lifetime) |
| **max_notify_body_length (int)** | [rls](https://www.kamailio.org/docs/modules/6.0.x/modules/rls.html#rls.p.max_notify_body_length) |
| **max_query_length (int)** | [db_cluster](https://www.kamailio.org/docs/modules/6.0.x/modules/db_cluster.html#db_cluster.p.max_query_length) |
| **max_result_rows (integer)** | [db_text](https://www.kamailio.org/docs/modules/6.0.x/modules/db_text.html) |
...
| **min_expires (integer)** | [registrar](https://www.kamailio.org/docs/modules/6.0.x/modules/registrar.html#registrar.p.min_expires) |
| **min_expires_action (int)** | [presence](https://www.kamailio.org/docs/modules/6.0.x/modules/presence.html#presence.p.min_expires_action) |
...
| **mos_average_jitter_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_jitter_B_pv) |
| **mos_average_jitter_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_jitter_pv) |
| **mos_average_packetloss_A_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_packetloss_A_pv) |
| **mos_average_packetloss_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_packetloss_B_pv) |
| **mos_average_packetloss_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_packetloss_pv) |
| **mos_average_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_pv) |
| **mos_average_roundtrip_A_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_roundtrip_A_pv) |
| **mos_average_roundtrip_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_roundtrip_B_pv) |
| **mos_average_roundtrip_leg_A_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_roundtrip_leg_A_pv) |
| **mos_average_roundtrip_leg_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_roundtrip_leg_B_pv) |
| **mos_average_roundtrip_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_average_roundtrip_pv) |
...
| **mos_max_jitter_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_max_jitter_pv) |
| **mos_max_packetloss_A_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_max_packetloss_A_pv) |
| **mos_max_packetloss_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_max_packetloss_B_pv) |
| **mos_max_packetloss_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_max_packetloss_pv) |
| **mos_max_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_max_pv) |
| **mos_max_roundtrip_A_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_max_roundtrip_A_pv) |
| **mos_max_roundtrip_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_max_roundtrip_B_pv) |
...
| **mos_min_jitter_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_jitter_pv) |
| **mos_min_packetloss_A_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_packetloss_A_pv) |
| **mos_min_packetloss_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_packetloss_B_pv) |
| **mos_min_packetloss_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_packetloss_pv) |
| **mos_min_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_pv) |
| **mos_min_roundtrip_A_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_roundtrip_A_pv) |
| **mos_min_roundtrip_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_roundtrip_B_pv) |
| **mos_min_roundtrip_leg_A_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_roundtrip_leg_A_pv) |
| **mos_min_roundtrip_leg_B_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_roundtrip_leg_B_pv) |
| **mos_min_roundtrip_pv (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.mos_min_roundtrip_pv) |
| **mqueue (string)** | [mqueue](https://www.kamailio.org/docs/modules/6.0.x/modules/mqueue.html#mqueue.p.mqueue) |
...
| **netio_key (str)** | [crypto](https://www.kamailio.org/docs/modules/6.0.x/modules/crypto.html#crypto.p.netio_key) |
| **netstring_format (int)** | [evapi](https://www.kamailio.org/docs/modules/6.0.x/modules/evapi.html#evapi.p.netstring_format) |
| **networks (string)** | [sms](https://www.kamailio.org/docs/modules/6.0.x/modules/sms.html#networks) |
| **new_uri_column (string)** | [speeddial](https://www.kamailio.org/docs/modules/6.0.x/modules/speeddial.html) |
| **nid_pool_no (integer)** | [auth](https://www.kamailio.org/docs/modules/6.0.x/modules/auth.html#auth.p.nid_pool_no) |
...
| **nonce_count (boolean)** | [auth](https://www.kamailio.org/docs/modules/6.0.x/modules/auth.html#auth.p.nonce_count) |
| **nonce_expire (integer)** | [auth](https://www.kamailio.org/docs/modules/6.0.x/modules/auth.html#auth.p.nonce_expire) |
| **nonsip_hook (int)** | [sipcapture](https://www.kamailio.org/docs/modules/6.0.x/modules/sipcapture.html#sipcapture.p.nonsip_hook) |
| **noreply (int)** | [sanity](https://www.kamailio.org/docs/modules/6.0.x/modules/sanity.html#sanity.p.noreply) |
| **nortpproxy_str (string)** | [nathelper](https://www.kamailio.org/docs/modules/6.0.x/modules/nathelper.html#nathelper.p.nortpproxy_str) |
| **nortpproxy_str (string)** | [rtpproxy](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpproxy.html#rtpproxy.p.nortpproxy_str) |
| **notification_address(str)** | [dmq](https://www.kamailio.org/docs/modules/6.0.x/modules/dmq.html#dmq.p.notification_address) |
| **notification_channel(str)** | [dmq](https://www.kamailio.org/docs/modules/6.0.x/modules/dmq.html#dmq.p.notification_channel) |
| **notifier_poll_rate (int)** | [presence](https://www.kamailio.org/docs/modules/6.0.x/modules/presence.html#presence.p.notifier_poll_rate) |
...
| **num_publish_workers (int)** | [nats](https://www.kamailio.org/docs/modules/6.0.x/modules/nats.html) |
| **num_workers(int)** | [dmq](https://www.kamailio.org/docs/modules/6.0.x/modules/dmq.html#dmq.p.num_workers) |
...
| **otn_in_flight_order (integer)** | [auth](https://www.kamailio.org/docs/modules/6.0.x/modules/auth.html#auth.p.otn_in_flight_order) |
| **outbound_mode (integer)** | [registrar](https://www.kamailio.org/docs/modules/6.0.x/modules/registrar.html#registrar.p.outbound_mode) |
| **outbound_proxy (str)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.outbound_proxy) |
| **outbound_proxy (str)** | [imc](https://www.kamailio.org/docs/modules/6.0.x/modules/imc.html#imc.p.outbound_proxy) |
| **outbound_proxy (str)** | [pua](https://www.kamailio.org/docs/modules/6.0.x/modules/pua.html) |
| **outbound_proxy (str)** | [rls](https://www.kamailio.org/docs/modules/6.0.x/modules/rls.html#rls.p.outbound_proxy) |
| **outbound_proxy (string)** | [msilo](https://www.kamailio.org/docs/modules/6.0.x/modules/msilo.html#msilo.p.outbound_proxy) |
...
| **path_use_received (integer)** | [registrar](https://www.kamailio.org/docs/modules/6.0.x/modules/registrar.html#registrar.p.path_use_received) |
| **pcre_caseless (int)** | [regex](https://www.kamailio.org/docs/modules/6.0.x/modules/regex.html#regex.p.pcre_caseless) |
| **pcre_dotall (int)** | [regex](https://www.kamailio.org/docs/modules/6.0.x/modules/regex.html#regex.p.pcre_dotall) |
| **pcre_extended (int)** | [regex](https://www.kamailio.org/docs/modules/6.0.x/modules/regex.html#regex.p.pcre_extended) |
| **pcre_multiline (int)** | [regex](https://www.kamailio.org/docs/modules/6.0.x/modules/regex.html#regex.p.pcre_multiline) |
| **pcscf_uri (string)** | [ims_registrar_pcscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_registrar_pcscf.html) |
| **peer_tag_avp (AVP string)** | [permissions](https://www.kamailio.org/docs/modules/6.0.x/modules/permissions.html#permissions.p.peer_tag_avp) |
| **peer_tag_mode (integer)** | [permissions](https://www.kamailio.org/docs/modules/6.0.x/modules/permissions.html#permissions.p.peer_tag_mode) |
...
| **ping_inactivate_threshold (integer)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.ping_inactivate_threshold) |
| **ping_interval (int)** | [db_unixodbc](https://www.kamailio.org/docs/modules/6.0.x/modules/db_unixodbc.html#db_unixodbc.p.ping_interval) |
...
| **pipe (integer:string:integer)** | [ratelimit](https://www.kamailio.org/docs/modules/6.0.x/modules/ratelimit.html) |
| **plain_password_column (string)** | [uid_auth_db](https://www.kamailio.org/docs/modules/6.0.x/modules/uid_auth_db.html#plain_password_column) |
| **plp_algorithm_column (string)** | [pipelimit](https://www.kamailio.org/docs/modules/6.0.x/modules/pipelimit.html#pipelimit.p.plp_algorithm_column) |
...
| **prefix (string)** | [pdt](https://www.kamailio.org/docs/modules/6.0.x/modules/pdt.html) |
| **prefix_column (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html) |
...
| **pv_dstid (string)** | [mtree](https://www.kamailio.org/docs/modules/6.0.x/modules/mtree.html#mtree.p.pv_dstid) |
| **pv_value (string)** | [mtree](https://www.kamailio.org/docs/modules/6.0.x/modules/mtree.html#mtree.p.pv_value) |
| **pv_values (string)** | [mtree](https://www.kamailio.org/docs/modules/6.0.x/modules/mtree.html#mtree.p.pv_values) |
| **pv_weight (string)** | [mtree](https://www.kamailio.org/docs/modules/6.0.x/modules/mtree.html#mtree.p.pv_weight) |
...
| **query_maxdatasize (int)** | [http_client](https://www.kamailio.org/docs/modules/6.0.x/modules/http_client.html#http_client.p.query_maxdatasize) |
| **query_period(int)** | [xcap_client](https://www.kamailio.org/docs/modules/6.0.x/modules/xcap_client.html#xcap_client.p.query_period) |
...
| **radius_config (string)** | [misc_radius](https://www.kamailio.org/docs/modules/6.0.x/modules/misc_radius.html#mrad.p.config) |
| **radius_config (string)** | [peering](https://www.kamailio.org/docs/modules/6.0.x/modules/peering.html) |
...
| **realm_prefix (string)** | [auth](https://www.kamailio.org/docs/modules/6.0.x/modules/auth.html#auth.p.realm_prefix) |
| **realm_prefix (string)** | [cplc](https://www.kamailio.org/docs/modules/6.0.x/modules/cplc.html#cplc.p.realm_prefix) |
| **realm_prefix (string)** | [registrar](https://www.kamailio.org/docs/modules/6.0.x/modules/registrar.html#registrar.p.realm_prefix) |
| **reason_from_hf (int)** | [acc](https://www.kamailio.org/docs/modules/6.0.x/modules/acc.html#acc.p.reason_from_hf) |
| **received_avp (str)** | [nathelper](https://www.kamailio.org/docs/modules/6.0.x/modules/nathelper.html#nathelper.p.received_avp) |
| **received_avp (str)** | [registrar](https://www.kamailio.org/docs/modules/6.0.x/modules/registrar.html#registrar.p.received_avp) |
| **received_avp (string)** | [ims_registrar_pcscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_registrar_pcscf.html) |
| **received_column (string)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.received_column) |
| **received_format (int)** | [path](https://www.kamailio.org/docs/modules/6.0.x/modules/path.html#path.p.received_format) |
| **received_name (str)** | [path](https://www.kamailio.org/docs/modules/6.0.x/modules/path.html#path.p.received_name) |
...
| **reg_db_table (string)** | [p_usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/p_usrloc.html) |
| **reg_db_table (string)** | [uac](https://www.kamailio.org/docs/modules/6.0.x/modules/uac.html#uac.p.reg_db_table) |
| **reg_db_url (string)** | [uac](https://www.kamailio.org/docs/modules/6.0.x/modules/uac.html#uac.p.reg_db_url) |
| **reg_gc_interval (int)** | [uac](https://www.kamailio.org/docs/modules/6.0.x/modules/uac.html#uac.p.reg_gc_interval) |
| **reg_hash_size (int)** | [uac](https://www.kamailio.org/docs/modules/6.0.x/modules/uac.html#uac.p.reg_hash_size) |
| **reg_id_column (string)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.reg_id_column) |
| **reg_keep_callid (int)** | [uac](https://www.kamailio.org/docs/modules/6.0.x/modules/uac.html#uac.p.reg_keep_callid) |
| **reg_random_delay (int)** | [uac](https://www.kamailio.org/docs/modules/6.0.x/modules/uac.html#uac.p.reg_random_delay) |
...
| **reload_db_subs (integer)** | [rls](https://www.kamailio.org/docs/modules/6.0.x/modules/rls.html#rls.p.reload_db_subs) |
...
| **request_uri_column (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html) |
...
| **restore_from_avp (string)** | [uac](https://www.kamailio.org/docs/modules/6.0.x/modules/uac.html#uac.p.restore_from_avp) |
...
| **rtpengine_sock (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.rtpengine_sock) |
| **rtpengine_tout_ms (integer)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.rtpengine_tout_ms) |
| **rtpproxy_disable_tout (integer)** | [rtpproxy](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpproxy.html#rtpproxy.p.rtpproxy_disable_tout) |
...
| **ruri_avp (str)** | [drouting](https://www.kamailio.org/docs/modules/6.0.x/modules/drouting.html#drouting.p.ruri_avp) |
...
| Name | Module Name |
|------|-------------|
| **salt (str)** | [crypto](https://www.kamailio.org/docs/modules/6.0.x/modules/crypto.html#crypto.p.salt) |
| **sampling_time_unit (integer)** | [pike](https://www.kamailio.org/docs/modules/6.0.x/modules/pike.html#pike.p.sampling_time_unit) |
...
| **sctp_assoc_reuse (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_assoc_reuse) |
| **sctp_assoc_tracking (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_assoc_tracking) |
| **sctp_autoclose (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_autoclose) |
| **sctp_hbinterval (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_hbinterval) |
| **sctp_init_max_attempts (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_init_max_attempts) |
| **sctp_init_max_timeo (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_init_max_timeo) |
| **sctp_max_assocs (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_max_assocs) |
| **sctp_max_burst (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_max_burst) |
| **sctp_pathmaxrxt (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_pathmaxrxt) |
| **sctp_sack_delay (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_sack_delay) |
| **sctp_sack_freq (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_sack_freq) |
| **sctp_send_retries (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_send_retries) |
| **sctp_send_ttl (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_send_ttl) |
| **sctp_socket_rcvbuf (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_socket_rcvbuf) |
| **sctp_socket_sndbuf (int)** | [sctp](https://www.kamailio.org/docs/modules/6.0.x/modules/sctp.html#sctp.p.sctp_socket_sndbuf) |
...
| **server_address(str)** | [dmq](https://www.kamailio.org/docs/modules/6.0.x/modules/dmq.html#dmq.p.server_address) |
| **server_address(str)** | [pua_bla](https://www.kamailio.org/docs/modules/6.0.x/modules/pua_bla.html) |
| **server_address(str)** | [pua_reginfo](https://www.kamailio.org/docs/modules/6.0.x/modules/pua_reginfo.html) |
| **server_address(str)** | [pua_xmpp](https://www.kamailio.org/docs/modules/6.0.x/modules/pua_xmpp.html#pua_xmpp.p.server_address) |
| **server_id_column (string)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.server_id_column) |
| **server_id_filter (int)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.server_id_filter) |
...
| **service_context_id_release(string)** | [ims_charging](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_charging.html) |
| **service_context_id_root(string)** | [ims_charging](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_charging.html) |
| **service_type (integer)** | [acc_radius](https://www.kamailio.org/docs/modules/6.0.x/modules/acc_radius.html#acc_radius.p.service_type) |
| **service_type (integer)** | [auth_radius](https://www.kamailio.org/docs/modules/6.0.x/modules/auth_radius.html#auth_radius.p.service_type) |
| **session_cache (boolean)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.session_cache) |
| **session_id (str)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.session_id) |
| **setid_avp (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.setid_avp) |
| **setid_col (string)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.setid_col) |
| **setid_col (string)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.setid_col) |
| **setid_default (integer)** | [rtpengine](https://www.kamailio.org/docs/modules/6.0.x/modules/rtpengine.html#rtpengine.p.setid_default) |
| **setid_pvname (str)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.setid_pvname) |
| **setvars (integer)** | [exec](https://www.kamailio.org/docs/modules/6.0.x/modules/exec.html#exec.p.setvars) |
| **sflags_column (string)** | [dialog](https://www.kamailio.org/docs/modules/6.0.x/modules/dialog.html#dialog.p.sflags_column) |
| **sha_algorithm (integer)** | [auth_ephemeral](https://www.kamailio.org/docs/modules/6.0.x/modules/auth_ephemeral.html#auth_eph.p.sha_algorithm) |
| **shvset (string)** | [pv](https://www.kamailio.org/docs/modules/6.0.x/modules/pv.html#pv.p.shvset) |
...
| **snd_time_avp (str)** | [msilo](https://www.kamailio.org/docs/modules/6.0.x/modules/msilo.html#msilo.p.snd_time_avp) |
...
| **step_usleep (int)** | [debugger](https://www.kamailio.org/docs/modules/6.0.x/modules/debugger.html#dbg.p.step_usleep) |
| **stopper_column (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html) |
| **storage (str)** | [topos](https://www.kamailio.org/docs/modules/6.0.x/modules/topos.html#topos.p.storage) |
...
| **subscriber_table (string)** | [carrierroute](https://www.kamailio.org/docs/modules/6.0.x/modules/carrierroute.html) |
...
| Name | Module Name |
|------|-------------|
| **table (str)** | [siptrace](https://www.kamailio.org/docs/modules/6.0.x/modules/siptrace.html#siptrace.p.table) |
| **table (string)** | [group](https://www.kamailio.org/docs/modules/6.0.x/modules/group.html#group.p.table) |
| **table_name (str)** | [sipcapture](https://www.kamailio.org/docs/modules/6.0.x/modules/sipcapture.html#sipcapture.p.table_name) |
...
| **tag_avp (AVP string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html#lcr.p.tag_avp) |
| **tag_col (string)** | [permissions](https://www.kamailio.org/docs/modules/6.0.x/modules/permissions.html#permissions.p.tag_col) |
| **tag_column (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html) |
| **tcp_ka_idle (integer)** | [http_async_client](https://www.kamailio.org/docs/modules/6.0.x/modules/http_async_client.html) |
...
| **timer_buffer(int)** | [ims_charging](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_charging.html) |
| **timer_interval (int)** | [dlgs](https://www.kamailio.org/docs/modules/6.0.x/modules/dlgs.html#dlgs.p.timer_interval) |
| **timer_interval (int)** | [ims_usrloc_pcscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_usrloc_pcscf.html) |
| **timer_interval (int)** | [ims_usrloc_scscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_usrloc_scscf.html#ims_usrloc_scscf.p.timer_interval) |
| **timer_interval (int)** | [msrp](https://www.kamailio.org/docs/modules/6.0.x/modules/msrp.html#msrp.p.timer_interval) |
| **timer_interval (int)** | [siprepo](https://www.kamailio.org/docs/modules/6.0.x/modules/siprepo.html#siprepo.p.timer_interval) |
| **timer_interval (int)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.timer_interval) |
| **timer_interval (integer)** | [htable](https://www.kamailio.org/docs/modules/6.0.x/modules/htable.html#htable.p.timer_interval) |
| **timer_interval (integer)** | [pipelimit](https://www.kamailio.org/docs/modules/6.0.x/modules/pipelimit.html#pipelimit.p.timer_interval) |
| **timer_interval (integer)** | [ratelimit](https://www.kamailio.org/docs/modules/6.0.x/modules/ratelimit.html) |
| **timer_interval (integer)** | [websocket](https://www.kamailio.org/docs/modules/6.0.x/modules/websocket.html#websocket.p.timer_interval) |
| **timer_mode (integer)** | [pipelimit](https://www.kamailio.org/docs/modules/6.0.x/modules/pipelimit.html#pipelimit.p.timer_mode) |
| **timer_mode (integer)** | [presence](https://www.kamailio.org/docs/modules/6.0.x/modules/presence.html#presence.p.timer_mode) |
| **timer_procs (int)** | [dialog](https://www.kamailio.org/docs/modules/6.0.x/modules/dialog.html#dialog.p.timer_procs) |
| **timer_procs (int)** | [siprepo](https://www.kamailio.org/docs/modules/6.0.x/modules/siprepo.html#siprepo.p.timer_procs) |
...
| **tls_debug (int)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.tls_debug) |
| **tls_disable_compression (boolean)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.tls_disable_compression) |
...
| **trace_local_ip (str)** | [siptrace](https://www.kamailio.org/docs/modules/6.0.x/modules/siptrace.html#siptrace.p.trace_local_ip) |
| **trace_mode (integer)** | [siptrace](https://www.kamailio.org/docs/modules/6.0.x/modules/siptrace.html#siptrace.p.trace_mode) |
| **trace_on (integer)** | [siptrace](https://www.kamailio.org/docs/modules/6.0.x/modules/siptrace.html#siptrace.p.trace_on) |
...
| **type_column (string)** | [avpops](https://www.kamailio.org/docs/modules/6.0.x/modules/avpops.html#avpops.p.type_column) |
| **type_column (string)** | [uid_avp_db](https://www.kamailio.org/docs/modules/6.0.x/modules/uid_avp_db.html) |

## [u]

| Name | Module Name |
|------|-------------|
| **udpping_from_path (int)** | [nathelper](https://www.kamailio.org/docs/modules/6.0.x/modules/nathelper.html#nathelper.p.udpping_from_path) |
| **uid_column (string)** | [uid_avp_db](https://www.kamailio.org/docs/modules/6.0.x/modules/uid_avp_db.html) |
| **unix_tx_timeout (integer)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.unix_tx_timeout) |
| **unmatched_cancel (integer)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.unmatched_cancel) |
| **unreg_validity (int)** | [ims_usrloc_scscf](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_usrloc_scscf.html#ims_usrloc_scscf.p.unreg_validity) |
| **uparam_name (str)** | [topoh](https://www.kamailio.org/docs/modules/6.0.x/modules/topoh.html#topoh.p.uparam_name) |
...
| **uri_extra (string)** | [misc_radius](https://www.kamailio.org/docs/modules/6.0.x/modules/misc_radius.html#mrad.p.uri_extra) |
| **uri_prefix_checks (integer)** | [topoh](https://www.kamailio.org/docs/modules/6.0.x/modules/topoh.html#topoh.p.uri_prefix_checks) |
| **uri_scheme_column (string)** | [lcr](https://www.kamailio.org/docs/modules/6.0.x/modules/lcr.html) |
...
| **url_match (str)** | [xhttp](https://www.kamailio.org/docs/modules/6.0.x/modules/xhttp.html#xhttp.p.url_match) |
...
| **use_domain (boolean)** | [auth](https://www.kamailio.org/docs/modules/6.0.x/modules/auth.html#auth.p.use_domain) |
| **use_domain (int)** | [alias_db](https://www.kamailio.org/docs/modules/6.0.x/modules/alias_db.html#alias_db.p.use_domain) |
| **use_domain (int)** | [auth_diameter](https://www.kamailio.org/docs/modules/6.0.x/modules/auth_diameter.html) |
| **use_domain (int)** | [carrierroute](https://www.kamailio.org/docs/modules/6.0.x/modules/carrierroute.html) |
| **use_domain (int)** | [drouting](https://www.kamailio.org/docs/modules/6.0.x/modules/drouting.html#drouting.p.use_domain) |
| **use_domain (int)** | [speeddial](https://www.kamailio.org/docs/modules/6.0.x/modules/speeddial.html) |
| **use_domain (int)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.use_domain) |
| **use_domain (integer)** | [auth_db](https://www.kamailio.org/docs/modules/6.0.x/modules/auth_db.html#auth_db.p.use_domain) |
| **use_domain (integer)** | [avpops](https://www.kamailio.org/docs/modules/6.0.x/modules/avpops.html#avpops.p.use_domain) |
| **use_domain (integer)** | [cplc](https://www.kamailio.org/docs/modules/6.0.x/modules/cplc.html#cplc.p.use_domain) |
| **use_domain (integer)** | [group](https://www.kamailio.org/docs/modules/6.0.x/modules/group.html#group.p.use_domain) |
...
| **uuid_column (string)** | [avpops](https://www.kamailio.org/docs/modules/6.0.x/modules/avpops.html#avpops.p.uuid_column) |
...
| **verbose_list (int)** | [websocket](https://www.kamailio.org/docs/modules/6.0.x/modules/websocket.html#websocket.p.verbose_list) |
| **verbosity (int)** | [db_redis](https://www.kamailio.org/docs/modules/6.0.x/modules/db_redis.html#db_redis.p.verbosity) |
| **verbosity (int)** | [lwsc](https://www.kamailio.org/docs/modules/6.0.x/modules/lwsc.html#lwsc.p.verbosity) |
| **verify_certificate (boolean)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.verify_certificate) |
| **verify_certificate (str)** | [mqtt](https://www.kamailio.org/docs/modules/6.0.x/modules/mqtt.html#mqtt.p.verify_certificate) |
| **verify_client (string)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.verify_client) |
| **verify_depth (integer)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.verify_depth) |
| **verify_destination_service_type (integer)** | [peering](https://www.kamailio.org/docs/modules/6.0.x/modules/peering.html) |
| **verify_host (int)** | [http_client](https://www.kamailio.org/docs/modules/6.0.x/modules/http_client.html#http_client.p.verify_host) |
| **verify_peer (int)** | [http_client](https://www.kamailio.org/docs/modules/6.0.x/modules/http_client.html#http_client.p.verify_peer) |
...
| **voice_rating_group(string)** | [ims_charging](https://www.kamailio.org/docs/modules/6.0.x/modules/ims_charging.html) |
...
| **vs_identity_expire_s (int)** | [stirshaken](https://www.kamailio.org/docs/modules/6.0.x/modules/stirshaken.html) |
| **vs_pptgrants_pvname (str)** | [stirshaken](https://www.kamailio.org/docs/modules/6.0.x/modules/stirshaken.html) |
| **vs_verify_x509_cert_path (int)** | [stirshaken](https://www.kamailio.org/docs/modules/6.0.x/modules/stirshaken.html) |
...
| Name | Module Name |
|------|-------------|
| **xavp_cfg (str)** | [presence](https://www.kamailio.org/docs/modules/6.0.x/modules/presence.html#presence.p.xavp_cfg) |
| **xavp_cfg (str)** | [rtjson](https://www.kamailio.org/docs/modules/6.0.x/modules/rtjson.html#rtjson.p.xavp_cfg) |
| **xavp_cfg (string)** | [registrar](https://www.kamailio.org/docs/modules/6.0.x/modules/registrar.html#registrar.p.xavp_cfg) |
| **xavp_cfg (string)** | [tls](https://www.kamailio.org/docs/modules/6.0.x/modules/tls.html#tls.p.xavp_cfg) |
| **xavp_contact (string)** | [tm](https://www.kamailio.org/docs/modules/6.0.x/modules/tm.html#tm.p.xavp_contact) |
| **xavp_contact (string)** | [usrloc](https://www.kamailio.org/docs/modules/6.0.x/modules/usrloc.html#usrloc.p.xavp_contact) |
| **xavp_ctx (str)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.xavp_ctx) |
| **xavp_ctx_mode (int)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.xavp_ctx_mode) |
| **xavp_dst (str)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.xavp_dst) |
| **xavp_dst_mode (int)** | [dispatcher](https://www.kamailio.org/docs/modules/6.0.x/modules/dispatcher.html#dispatcher.p.xavp_dst_mode) |
| **xavp_rcd (string)** | [registrar](https://www.kamailio.org/docs/modules/6.0.x/modules/registrar.html#registrar.p.xavp_rcd) |
| **xavp_rcd_mask (int)** | [registrar](https://www.kamailio.org/docs/modules/6.0.x/modules/registrar.html#registrar.p.xavp_rcd_mask) |
| **xavu_cfg (str)** | [topos](https://www.kamailio.org/docs/modules/6.0.x/modules/topos.html#topos.p.xavu_cfg) |
...
| **xcap_server (str)** | [presence_xml](https://www.kamailio.org/docs/modules/6.0.x/modules/presence_xml.html#presence_xml.p.xcap_server) |
| **xcap_table (string)** | [utils](https://www.kamailio.org/docs/modules/6.0.x/modules/utils.html#utils.p.xcap_table) |
| **xcap_table (string)** | [xcap_server](https://www.kamailio.org/docs/modules/6.0.x/modules/xcap_server.html#xcap_server.p.xcap_table) |
...
| **xhttp_pi_buf_size (int)** | [xhttp_pi](https://www.kamailio.org/docs/modules/6.0.x/modules/xhttp_pi.html) |
...
| **xlbuf_size (integer)** | [avp](https://www.kamailio.org/docs/modules/6.0.x/modules/avp.html#avp.p.xlbuf_size) |
| **xml_ns (str)** | [xcap_server](https://www.kamailio.org/docs/modules/6.0.x/modules/xcap_server.html#xcap_server.p.xml_ns) |
| **xml_ns (str)** | [xmlops](https://www.kamailio.org/docs/modules/6.0.x/modules/xmlops.html#xmlops.p.xml_ns) |
| **xmpp_domain (string)** | [xmpp](https://www.kamailio.org/docs/modules/6.0.x/modules/xmpp.html) |
| **xmpp_host (string)** | [xmpp](https://www.kamailio.org/docs/modules/6.0.x/modules/xmpp.html) |
| **xmpp_password (string)** | [xmpp](https://www.kamailio.org/docs/modules/6.0.x/modules/xmpp.html) |
| **xmpp_port (integer)** | [xmpp](https://www.kamailio.org/docs/modules/6.0.x/modules/xmpp.html) |
| **xval_mode (int)** | [app_ruby](https://www.kamailio.org/docs/modules/6.0.x/modules/app_ruby.html#app_ruby.p.xval_mode) |
