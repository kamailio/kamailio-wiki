...
| **allow_routing(basename)**                                     | *modules*   | [permissions](http://www.kamailio.org/docs/modules/4.3.x/modules/permissions.html#permissions.f.allow_routing_basename)     |
...
| **attr_exists(attribute)**                                      | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#avp.f.attr_exists)                                        |
...
| **avp_subst(avps, subst)**                                      | *modules*   | [avpops](http://www.kamailio.org/docs/modules/4.3.x/modules/avpops.html#avpops.f.avp_subst)                                 |
...
| **check_route_param(re)**                                                                     | *modules*   | [rr](http://www.kamailio.org/docs/modules/4.3.x/modules/rr.html#check-route-param-id)                                       |
...
| **cpl_run_script(type,mode, \[uri\])**                                                        | *modules*   | [cpl-c](http://www.kamailio.org/docs/modules/4.3.x/modules/cpl-c.html)                                                      |
...
| **dlg_refer(side, address)**                                | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.3.x/modules/dialog.html)                                       |
...
| **ds_next_dst()**                                           | *modules*   | [dispatcher](http://www.kamailio.org/docs/modules/4.3.x/modules/dispatcher.html)                               |
...
| **from_gw(lcr_id\[, ip_addr, proto\])**   | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.3.x/modules/lcr.html)                                            |
...
| **iptrtpproxy_set_param("remove_codec_mask", value)**                            | *modules*   | [iptrtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/iptrtpproxy.html#iptrtpproxy_set_param(remove_codec_mask))     |
...
| **is_in_subnet (ip, subnet)**                                                    | *modules*   | [ipops](http://www.kamailio.org/docs/modules/4.3.x/modules/ipops.html#ipops.f.is_in_subnet)                                     |
...
| **is_ugflag(flag_num)**                                                          | *modules*   | [uid_gflags](http://www.kamailio.org/docs/modules/4.3.x/modules/uid_gflags.html#is_ugflag)                                      |
...
| **jsonrpc_request(method, parameters, return_route, error_route, result_var)**           | *modules*   | [jsonrpc-c](http://www.kamailio.org/docs/modules/4.3.x/modules/jsonrpc-c.html)                                   |
...
| **msrp_is_reply()**                                              | *modules*   | [msrp](http://www.kamailio.org/docs/modules/4.3.x/modules/msrp.html#msrp.f.msrp_is_reply)                           |
...
| **pl_check(name \[, algorithm, limit\])**                           | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/4.3.x/modules/pipelimit.html#pipelimit.f.pl_check)           |
...
| **pv_auth_check(realm, passwd, flags, checks)**                     | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.3.x/modules/auth.html#auth.f.pv_auth_check)                     |
...
| **reginfo_subscribe(uri\[, expires\])**                                                           | *modules*   | [pua_reginfo](http://www.kamailio.org/docs/modules/4.3.x/modules/pua_reginfo.html)                                     |
...
| **reg_fetch_contacts(domain, uri, profile)**                                                      | *modules*   | [ims_registrar_scscf](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_registrar_scscf.html)                     |
| **reg_fetch_contacts(domain, uri, profile)**                                                      | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.3.x/modules/registrar.html#registrar.f.reg_fetch_contacts)          |
| **reg_free_contacts(profile)**                                                                    | *modules*   | [ims_registrar_scscf](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_registrar_scscf.html)                     |
| **reg_free_contacts(profile)**                                                                    | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.3.x/modules/registrar.html#registrar.f.reg_free_contacts)           |
| **remove_body()**                                                                                 | *modules*   | [textopsx](http://www.kamailio.org/docs/modules/4.3.x/modules/textopsx.html#textopsx.f.remove_body)                    |
| **remove_body_part(content_type)**                                                                | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.remove_body_part)                  |
| **remove_extra_attrs (group_id, id)**                                                             | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.3.x/modules/uid_avp_db.html)                                       |
| **remove_hf(hname)**                                                                              | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.remove_hf)                         |
| **remove_hf_re(re)**                                                                              | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.remove_hf_re)                      |
| **remove_hf_value(hf_par)**                                                                       | *modules*   | [textopsx](http://www.kamailio.org/docs/modules/4.3.x/modules/textopsx.html#textopsx.f.remove_hf_value)                |
| **remove_hf_value2(hf_par)**                                                                      | *modules*   | [textopsx](http://www.kamailio.org/docs/modules/4.3.x/modules/textopsx.html#textopsx.f.remove_hf_value2)               |
| **remove_record_route()**                                                                         | *modules*   | [rr](http://www.kamailio.org/docs/modules/4.3.x/modules/rr.html#remove-record-route-id)                                |
| **replace(re, txt)**                                                                              | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.replace)                           |
| **replace_all(re, txt)**                                                                          | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.replace_all)                       |
| **replace_attr_hf(header_name, $avp_name)**                                                       | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#avp.f.replace_attr_hf_2)                             |
| **replace_attr_hf(name)**                                                                         | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#avp.f.replace_attr_hf_1)                             |
| **replace_body(re, txt)**                                                                         | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.replace_body)                      |
| **replace_body_all(re, txt)**                                                                     | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.replace_body_all)                  |
| **replace_body_atonce(re, txt)**                                                                  | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.replace_body_atonce)               |
| **reportospusage()**                                                                              | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.3.x/modules/osp.html)                                                     |
| **requestosprouting()**                                                                           | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.3.x/modules/osp.html)                                                     |
| **resetbflag(flag \[, branch\])**                                                                 | *modules*   | [kex](http://www.kamailio.org/docs/modules/4.3.x/modules/kex.html#kex.f.resetbflag)                                    |
| **resetdebug()**                                                                                  | *modules*   | [kex](http://www.kamailio.org/docs/modules/4.3.x/modules/kex.html#kex.f.resetdebug)                                    |
| **resetdsturi()**                                                                                 | *modules*   | [kex](http://www.kamailio.org/docs/modules/4.3.x/modules/kex.html#kex.f.resetdsturi)                                   |
| **resetsflag(flag)**                                                                              | *modules*   | [kex](http://www.kamailio.org/docs/modules/4.3.x/modules/kex.html#kex.f.resetsflag)                                    |
| **reset_gflag(flag)**                                                                             | *modules*   | [cfgutils](http://www.kamailio.org/docs/modules/4.3.x/modules/cfgutils.html#cfgutils.f.reset_gflag)                    |
| **reset_stat(variable)**                                                                          | *modules*   | [statistics](http://www.kamailio.org/docs/modules/4.3.x/modules/statistics.html#statistics.f.reset_stat)               |
| **reset_ugflag(flag_num)**                                                                        | *modules*   | [uid_gflags](http://www.kamailio.org/docs/modules/4.3.x/modules/uid_gflags.html#reset_ugflag)                          |
| **ring_insert_callid()**                                                                          | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.3.x/modules/siputils.html#siputils.f.ring_insert_callid)             |
| **rls_handle_notify()**                                                                           | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.3.x/modules/rls.html)                                                     |
| **rls_handle_subscribe(\[watcher_uri\])**                                                         | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.3.x/modules/rls.html)                                                     |
| **rls_update_subs(uri, event)**                                                                   | *modules*   | [rls](http://www.kamailio.org/docs/modules/4.3.x/modules/rls.html)                                                     |
| **rl_check(\[pvar\])**                                                                            | *modules*   | [ratelimit](http://www.kamailio.org/docs/modules/4.3.x/modules/ratelimit.html)                                         |
| **rl_check_pipe(\[pipe_no\])**                                                                    | *modules*   | [ratelimit](http://www.kamailio.org/docs/modules/4.3.x/modules/ratelimit.html)                                         |
| **route_if_exists(route)**                                                                        | *modules*   | [cfgutils](http://www.kamailio.org/docs/modules/4.3.x/modules/cfgutils.html#cfgutils.f.route_if_exists)                |
| **Ro_CCR(route_name, direction, reservation_units, domain, incoming_trunk_id, outgoing_trunk_id** | *modules*   | [ims_charging](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_charging.html)                                   |
| **rtjson_init_routes(rtdoc)**                                                                     | *modules*   | [rtjson](http://www.kamailio.org/docs/modules/4.3.x/modules/rtjson.html#rtjson.f.rtjson_init_routes)                   |
| **rtjson_next_route()**                                                                           | *modules*   | [rtjson](http://www.kamailio.org/docs/modules/4.3.x/modules/rtjson.html#rtjson.f.rtjson_next_route)                    |
| **rtjson_push_routes()**                                                                          | *modules*   | [rtjson](http://www.kamailio.org/docs/modules/4.3.x/modules/rtjson.html#rtjson.f.rtjson_push_routes)                   |
| **rtjson_update_branch()**                                                                        | *modules*   | [rtjson](http://www.kamailio.org/docs/modules/4.3.x/modules/rtjson.html#rtjson.f.rtjson_update_branch)                 |
| **rtpengine_answer(\[flags\])**                                                                   | *modules*   | [rtpengine](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpengine.html#rtpengine.f.rtpengine_answer)            |
| **rtpengine_delete(\[flags\])**                                                                   | *modules*   | [rtpengine](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpengine.html#rtpengine.f.rtpengine_delete)            |
| **rtpengine_manage(\[flags\])**                                                                   | *modules*   | [rtpengine](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpengine.html#rtpengine.f.rtpengine_manage)            |
| **rtpengine_offer(\[flags\])**                                                                    | *modules*   | [rtpengine](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpengine.html#rtpengine.f.rtpengine_offer)             |
| **rtpproxy_answer(\[flags \[, ip_address\]\])**                                                   | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html)                                           |
| **rtpproxy_destroy(\[flags\])**                                                                   | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html)                                           |
| **rtpproxy_manage(\[flags \[, ip_address\]\])**                                                   | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html)                                           |
| **rtpproxy_offer(\[flags \[, ip_address\]\])**                                                    | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html)                                           |
| **rtpproxy_stop_stream2uac(),**                                                                   | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html#rtpproxy_stop_stream2uac)                  |
| **rtpproxy_stop_stream2uas(prompt_name, count)**                                                  | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html#rtpproxy_stop_stream2uas)                  |
| **rtpproxy_stream2uac(prompt_name, count),**                                                      | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html#rtpproxy_stream2uac)                       |
| **rtpproxy_stream2uas(prompt_name, count)**                                                       | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html#rtpproxy_stream2uas)                       |
| **Rx_AAR(route_block, direction, subscription_id, subscription_id_type)**                         | *modules*   | [ims_qos](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_qos.html)                                             |
| **Rx_AAR_Register(route_block, domain)**                                                          | *modules*   | [ims_qos](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_qos.html)                                             |

## \[S\]

| Name                                                                                | Module Path | Module Name                                                                                                  |
|-------------------------------------------------------------------------------------|-------------|--------------------------------------------------------------------------------------------------------------|
| **sanity_check(\[msg_checks \[, uri_checks\]\])**                                   | *modules*   | [sanity](http://www.kamailio.org/docs/modules/4.3.x/modules/sanity.html#sanity.f.sanity_check)               |
| **save(async_reply_route, domain)**                                                 | *modules*   | [ims_registrar_scscf](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_registrar_scscf.html)           |
| **save(domain, \[, flags \[, uri\]\])**                                             | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.3.x/modules/registrar.html#registrar.f.save)              |
| **save_extra_attrs (group_id, id)**                                                 | *modules*   | [uid_avp_db](http://www.kamailio.org/docs/modules/4.3.x/modules/uid_avp_db.html)                             |
| **sbranch_append()**                                                                | *modules*   | [pv](http://www.kamailio.org/docs/modules/4.3.x/modules/pv.html#pv.f.sbranch_append)                         |
| **sbranch_reset()**                                                                 | *modules*   | [pv](http://www.kamailio.org/docs/modules/4.3.x/modules/pv.html#pv.f.sbranch_reset)                          |
| **sbranch_set_ruri()**                                                              | *modules*   | [pv](http://www.kamailio.org/docs/modules/4.3.x/modules/pv.html#pv.f.sbranch_set_ruri)                       |
| **sca_call_info_update()**                                                          | *modules*   | [sca](http://www.kamailio.org/docs/modules/4.3.x/modules/sca.html)                                           |
| **sca_handle_subscribe()**                                                          | *modules*   | [sca](http://www.kamailio.org/docs/modules/4.3.x/modules/sca.html)                                           |
| **sdp_content()**                                                                   | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_content)                |
| **sdp_get(avpvar)**                                                                 | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_get)                    |
| **sdp_get_line_startswith(avpvar, string)**                                         | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_get_line_startswith)    |
| **sdp_keep_codecs_by_id(list \[, mtype\])**                                         | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.keep_codecs_by_id)          |
| **sdp_keep_codecs_by_name(list \[, mtype\])**                                       | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.keep_codecs_by_name)        |
| **sdp_mangle_ip(pattern, newip)**                                                   | *modules*   | [mangler](http://www.kamailio.org/docs/modules/4.3.x/modules/mangler.html#mangler.f.sdp_mangle_ip)           |
| **sdp_mangle_port(offset)**                                                         | *modules*   | [mangler](http://www.kamailio.org/docs/modules/4.3.x/modules/mangler.html#mangler.f.sdp_mangle_port)         |
| **sdp_print(level)**                                                                | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_print)                  |
| **sdp_remove_codecs_by_id(list)**                                                   | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.remove_codecs_by_id)        |
| **sdp_remove_codecs_by_name(list)**                                                 | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.remove_codecs_by_name)      |
| **sdp_remove_line_by_prefix(string)**                                               | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.remove_line_by_prefix)      |
| **sdp_remove_media(type)**                                                          | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_remove_media)           |
| **sdp_remove_transport(type)**                                                      | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_remove_transport)       |
| **sdp_transport(pv)**                                                               | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_transport)              |
| **sdp_with_active_media(type)**                                                     | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_with_active_media)      |
| **sdp_with_codecs_by_id(list)**                                                     | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_with_codecs_by_id)      |
| **sdp_with_codecs_by_name(list)**                                                   | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdspops.f.sdp.with_codecs_by_name)   |
| **sdp_with_ice()**                                                                  | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_with_ice)               |
| **sdp_with_media(type)**                                                            | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_with_media)             |
| **sdp_with_transport(type)**                                                        | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_with_transport)         |
| **sdp_with_transport_like(string)**                                                 | *modules*   | [sdpops](http://www.kamailio.org/docs/modules/4.3.x/modules/sdpops.html#sdpops.f.sdp_with_transport_like)    |
| **sd_lookup(table \[, owner\])**                                                    | *modules*   | [speeddial](http://www.kamailio.org/docs/modules/4.3.x/modules/speeddial.html)                               |
| **search(re)**                                                                      | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.search)                  |
| **search_append(re, txt)**                                                          | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.search_append)           |
| **search_append_body(re, txt)**                                                     | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.search_append_body)      |
| **search_body(re)**                                                                 | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.search_body)             |
| **search_hf(hf, re, flags)**                                                        | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.search_hf)               |
| **send(\[ host \[ :port \] \])**                                                    | *modules*   | [corex](http://www.kamailio.org/docs/modules/4.3.x/modules/corex.html)                                       |
| **send_data(uri, data)**                                                            | *modules*   | [corex](http://www.kamailio.org/docs/modules/4.3.x/modules/corex.html)                                       |
| **send_reply(code, reason)**                                                        | *modules*   | [sl](http://www.kamailio.org/docs/modules/4.3.x/modules/sl.html#send_reply)                                  |
| **send_tcp(\[ host \[ :port \] \])**                                                | *modules*   | [corex](http://www.kamailio.org/docs/modules/4.3.x/modules/corex.html)                                       |
| **setbflag(flag \[, branch\])**                                                     | *modules*   | [kex](http://www.kamailio.org/docs/modules/4.3.x/modules/kex.html#kex.f.setbflag)                            |
| **setdebug(level)**                                                                 | *modules*   | [kex](http://www.kamailio.org/docs/modules/4.3.x/modules/kex.html#kex.f.setdebug)                            |
| **setdsturi(uri)**                                                                  | *modules*   | [kex](http://www.kamailio.org/docs/modules/4.3.x/modules/kex.html#kex.f.setdsturi)                           |
| **setsflag(flag)**                                                                  | *modules*   | [kex](http://www.kamailio.org/docs/modules/4.3.x/modules/kex.html#kex.f.setsflag)                            |
| **set_accept_filter(filter,flags)**                                                 | *modules*   | [uac_redirect](http://www.kamailio.org/docs/modules/4.3.x/modules/uac_redirect.html)                         |
| **set_body(txt,content_type)**                                                      | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.set_body)                |
| **set_body_multipart(\[txt,content_type\]\[,boundary\])**                           | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.set_body_multipart)      |
| **set_contact_alias()**                                                             | *modules*   | [nathelper](http://www.kamailio.org/docs/modules/4.3.x/modules/nathelper.html#nathelper.set_contact_alias)   |
| **set_deny_filter(filter,flags)**                                                   | *modules*   | [uac_redirect](http://www.kamailio.org/docs/modules/4.3.x/modules/uac_redirect.html)                         |
| **set_dlg_profile(profile,\[value\])**                                              | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.3.x/modules/dialog.html)                                     |
| **set_dlg_profile(profile,\[value\])**                                              | *modules*   | [dialog_ng](http://www.kamailio.org/docs/modules/4.3.x/modules/dialog_ng.html)                               |
| **set_gflag(flag)**                                                                 | *modules*   | [cfgutils](http://www.kamailio.org/docs/modules/4.3.x/modules/cfgutils.html#cfgutils.f.set_gflag)            |
| **set_gflag(flag_num)**                                                             | *modules*   | [uid_gflags](http://www.kamailio.org/docs/modules/4.3.x/modules/uid_gflags.html#set_ugflag)                  |
| **set_iattr(attribute,value)**                                                      | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#avp.f.set_iattr)                           |
| **set_reply_body(txt,content_type)**                                                | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.set_reply_body)          |
| **set_rtpengine_set(setid\[, setid\])**                                             | *modules*   | [rtpengine](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpengine.html#rtpengine.f.set_rtpengine_set) |
| **set_rtp_proxy_set(setid)**                                                        | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html)                                 |
| **set_sattr(attribute,value)**                                                      | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#avp.f.set_sattr)                           |
| **set_uri_host(uri, host)**                                                         | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.3.x/modules/siputils.html#siputils.f.set_uri_host)         |
| **set_uri_user(uri, user)**                                                         | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.3.x/modules/siputils.html#siputils.f.set_uri_user)         |
| **shm_status()**                                                                    | *modules*   | [cfgutils](http://www.kamailio.org/docs/modules/4.3.x/modules/cfgutils.html#cfgutils.f.shm_status)           |
| **shm_summary()**                                                                   | *modules*   | [cfgutils](http://www.kamailio.org/docs/modules/4.3.x/modules/cfgutils.html#cfgutils.f.shm_summary)          |
| **sht_iterator_end(iname)**                                                         | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_iterator_end)           |
| **sht_iterator_next(iname)**                                                        | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_iterator_next)          |
| **sht_iterator_start(iname, hname)**                                                | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_iterator_start)         |
| **sht_lock(htable=>key)**                                                           | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_lock)                   |
| **sht_print()**                                                                     | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_print)                  |
| **sht_reset(htable)**                                                               | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_reset)                  |
| **sht_rm_name_re(htable=>regexp)**                                                  | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_rm_name_re)             |
| **sht_rm_value_re(htable=>regexp)**                                                 | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_rm_value_re)            |
| **sht_unlock(htable=>key)**                                                         | *modules*   | [htable](http://www.kamailio.org/docs/modules/4.3.x/modules/htable.html#htable.f.sht_unlock)                 |
| **sipt_destination(destination, hops, nai)**                                        | *modules*   | [sipt](http://www.kamailio.org/docs/modules/4.3.x/modules/sipt.html#sipt.f.sipt_destination)                 |
| **sipt_set_bci_1(charge_indicator, called_status, called_category, e2e_indicator)** | *modules*   | [sipt](http://www.kamailio.org/docs/modules/4.3.x/modules/sipt.html#sipt.f.sipt_set_bci_1)                   |
| **sipt_set_calling(origin, nai, presentation, screening)**                          | *modules*   | [sipt](http://www.kamailio.org/docs/modules/4.3.x/modules/sipt.html#sipt.f.sipt_set_calling)                 |
| **sip_trace(\[address\])**                                                          | *modules*   | [siptrace](http://www.kamailio.org/docs/modules/4.3.x/modules/siptrace.html#siptrace.f.sip_trace)            |
| **sleep(time)**                                                                     | *modules*   | [cfgutils](http://www.kamailio.org/docs/modules/4.3.x/modules/cfgutils.html#cfgutils.f.sleep)                |
| **sl_forward \_reply(\[ code, \[ reason \] \])**                                    | *modules*   | [sl](http://www.kamailio.org/docs/modules/4.3.x/modules/sl.html#sl_forward_reply)                            |
| **sl_reply_error()**                                                                | *modules*   | [sl](http://www.kamailio.org/docs/modules/4.3.x/modules/sl.html#sl_reply_error)                              |
| **sl_send_reply(code, reason)**                                                     | *modules*   | [sl](http://www.kamailio.org/docs/modules/4.3.x/modules/sl.html#sl_send_reply)                               |
| **sms_send_msg()**                                                                  | *modules*   | [sms](http://www.kamailio.org/docs/modules/4.3.x/modules/sms.html#sms_send_msg)                              |
| **sms_send_msg_to_net(network_name)**                                               | *modules*   | [sms](http://www.kamailio.org/docs/modules/4.3.x/modules/sms.html#sms_send_msg_to_net)                       |
| **sql_pvquery(connection, query, result)**                                          | *modules*   | [sqlops](http://www.kamailio.org/docs/modules/4.3.x/modules/sqlops.html)                                     |
| **sql_query(connection, query\[, result\])**                                        | *modules*   | [sqlops](http://www.kamailio.org/docs/modules/4.3.x/modules/sqlops.html)                                     |
| **sql_query_async(connection, query)**                                              | *modules*   | [sqlops](http://www.kamailio.org/docs/modules/4.3.x/modules/sqlops.html#sqlops.f.sql_query_async)            |
| **sql_result_free(result)**                                                         | *modules*   | [sqlops](http://www.kamailio.org/docs/modules/4.3.x/modules/sqlops.html)                                     |
| **sql_xquery(connection, query, result)**                                           | *modules*   | [sqlops](http://www.kamailio.org/docs/modules/4.3.x/modules/sqlops.html)                                     |
| **srv_query(srvcname, pvid)**                                                       | *modules*   | [ipops](http://www.kamailio.org/docs/modules/4.3.x/modules/ipops.html#ipops.f.srv_query)                     |
| **sstCheckMin(send_reply_flag)**                                                    | *modules*   | [sst](http://www.kamailio.org/docs/modules/4.3.x/modules/sst.html#sst.f.sstcheckmin)                         |
| **starts_with(str1, str2)**                                                         | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.starts_with)             |
| **start_recording()**                                                               | *modules*   | [rtpengine](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpengine.html#rtpengine.f.start_recording)   |
| **start_recording()**                                                               | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/rtpproxy.html)                                 |
| **statsd_decr(key)**                                                                | *modules*   | [statsd](http://www.kamailio.org/docs/modules/4.3.x/modules/statsd.html#statsd.f.statsd_decr)                |
| **statsd_gauge(key, value)**                                                        | *modules*   | [statsd](http://www.kamailio.org/docs/modules/4.3.x/modules/statsd.html#statsd.f.statsd_gauge)               |
| **statsd_incr(key)**                                                                | *modules*   | [statsd](http://www.kamailio.org/docs/modules/4.3.x/modules/statsd.html#statsd.f.statsd_incr)                |
| **statsd_set(key, value)**                                                          | *modules*   | [statsd](http://www.kamailio.org/docs/modules/4.3.x/modules/statsd.html#statsd.f.statsd_set)                 |
| **statsd_start(key)**                                                               | *modules*   | [statsd](http://www.kamailio.org/docs/modules/4.3.x/modules/statsd.html#statsd.f.statsd_start)               |
| **statsd_stop(key)**                                                                | *modules*   | [statsd](http://www.kamailio.org/docs/modules/4.3.x/modules/statsd.html#statsd.f.statsd_stop)                |
| **subscribe_to_reg(domain)**                                                        | *modules*   | [ims_registrar_scscf](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_registrar_scscf.html)           |
| **subst('/re/repl/flags')**                                                         | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.subst)                   |
| **subst_attr($avp_name, subst_re)**                                                 | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#avp.f.subst_attr)                          |
| **subst_body('/re/repl/flags')**                                                    | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.subst_body)              |
| **subst_hf(hf, subexp, flags)**                                                     | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.subst_hf)                |
| **subst_uri('/re/repl/flags')**                                                     | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.subst_uri)               |
| **subst_user('/re/repl/flags')**                                                    | *modules*   | [textops](http://www.kamailio.org/docs/modules/4.3.x/modules/textops.html#textops.f.subst_user)              |

## \[T\]

| Name                                                       | Module Path | Module Name                                                                                                   |
|------------------------------------------------------------|-------------|---------------------------------------------------------------------------------------------------------------|
| **tcp_keepalive_disable(\[conid\])**                       | *modules*   | [tcpops](http://www.kamailio.org/docs/modules/4.3.x/modules/tcpops.html#tcpops.f.tcp_keepalive_disable)       |
| **tcp_keepalive_enable(\[conid\], idle, count, interval)** | *modules*   | [tcpops](http://www.kamailio.org/docs/modules/4.3.x/modules/tcpops.html#tcpops.f.tcp_keepalive_enable)        |
| **tcp_set_connection_lifetime(\[conid\], lifetime)**       | *modules*   | [tcpops](http://www.kamailio.org/docs/modules/4.3.x/modules/tcpops.html#tcpops.f.tcp_set_connection_lifetime) |
| **tel2sip(uri, hostpart, result)**                         | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.3.x/modules/siputils.html#siputils.f.tel2sip)               |
| **term_impu_registered(domain)**                           | *modules*   | [ims_registrar_scscf](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_registrar_scscf.html)            |
| **time_period_match(period \[, timestamp\])**              | *modules*   | [tmrec](http://www.kamailio.org/docs/modules/4.3.x/modules/tmrec.html#tmrec.f.time_period_match)              |
| **tmrec_match(timerec \[, timestamp\])**                   | *modules*   | [tmrec](http://www.kamailio.org/docs/modules/4.3.x/modules/tmrec.html#tmrec.f.tmrec_match)                    |
| **to_any_gw(\[ip_addr, proto\])**                          | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.3.x/modules/lcr.html)                                            |
| **to_gw(lcr_id\[, ip_addr, proto\])**                      | *modules*   | [lcr](http://www.kamailio.org/docs/modules/4.3.x/modules/lcr.html)                                            |
| **ts_append(domain, ruri)**                                | *modules*   | [tsilo](http://www.kamailio.org/docs/modules/4.3.x/modules/tsilo.html)                                        |
| **ts_append_to(tindex, tlabel, domain)**                   | *modules*   | [tsilo](http://www.kamailio.org/docs/modules/4.3.x/modules/tsilo.html)                                        |
| **ts_store()**                                             | *modules*   | [tsilo](http://www.kamailio.org/docs/modules/4.3.x/modules/tsilo.html)                                        |
| **typeof(pvar, vtype)**                                    | *modules*   | [pv](http://www.kamailio.org/docs/modules/4.3.x/modules/pv.html)                                              |
| **t_any_replied()**                                        | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_any_replied)                           |
| **t_any_timeout()**                                        | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_any_timeout)                           |
| **t_branch_replied()**                                     | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_branch_replied)                        |
| **t_branch_timeout()**                                     | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_branch_timeout)                        |
| **t_cancel_branches(which)**                               | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_cancel_branches)                    |
| **t_cancel_callid(callid, cseq, flag \[, rcode\])**        | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_cancel_callid)                      |
| **t_check_status(re)**                                     | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_check_status)                          |
| **t_check_trans()**                                        | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_check_trans)                           |
| **t_continue(tindex, tlabel, rtname)**                     | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_continue)                           |
| **t_drop_replies(\[mode\])**                               | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_drop_replies)                          |
| **t_flush_flags()**                                        | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_flush_flags)                        |
| **t_forward_nonack(\[ip, port\])**                         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_forward_nonack)                        |
| **t_forward_nonack_sctp(ip, port)**                        | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_forward_nonack_sctp)                   |
| **t_forward_nonack_tcp(ip, port)**                         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_forward_nonack_tcp)                    |
| **t_forward_nonack_tls(ip, port)**                         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_forward_nonack_tls)                    |
| **t_forward_nonack_udp(ip, port)**                         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_forward_nonack_udp)                    |
| **t_grep_status("code")**                                  | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_grep_status)                           |
| **t_is_branch_route()**                                    | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_is_branch_route)                    |
| **t_is_canceled()**                                        | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_is_canceled)                           |
| **t_is_expired()**                                         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_is_expired)                            |
| **t_is_failure_route()**                                   | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_is_failure_route)                   |
| **t_is_reply_route()**                                     | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_is_reply_route)                     |
| **t_is_retr_async_reply()**                                | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_is_retr_async_reply)                   |
| **t_is_set(target)**                                       | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_is_set)                                |
| **t_load_contacts()**                                      | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_load_contacts)                         |
| **t_lookup_cancel(\[1\])**                                 | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_lookup_cancel)                         |
| **t_lookup_request()**                                     | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_lookup_request)                        |
| **t_newtran()**                                            | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_newtran)                               |
| **t_next_contacts()**                                      | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_next_contacts)                         |
| **t_next_contact_flow()**                                  | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_next_contact_flow)                     |
| **t_on_branch(branch_route)**                              | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_on_branch)                             |
| **t_on_branch_failure(branch_failure_route)**              | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_on_branch_failure)                     |
| **t_on_failure(failure_route)**                            | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_on_failure)                            |
| **t_on_reply(onreply_route)**                              | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_on_reply)                              |
| **t_precheck_trans()**                                     | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_precheck_trans)                     |
| **t_relay(\[host, port\])**                                | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_relay)                                 |
| **t_relay_cancel()**                                       | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_relay_cancel)                          |
| **t_relay_to(proxy, flags)**                               | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_relay_to)                              |
| **t_relay_to_sctp(\[ip, port\])**                          | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_relay_to_sctp)                         |
| **t_relay_to_tcp(\[ip, port\])**                           | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_relay_to_tcp)                          |
| **t_relay_to_tls(\[ip, port\])**                           | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_relay_to_tls)                          |
| **t_relay_to_udp(\[ip, port\])**                           | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_relay_to_udp)                          |
| **t_release()**                                            | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_release)                               |
| **t_replicate(\[params\])**                                | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_replicate)                             |
| **t_reply(code, reason_phrase)**                           | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_reply)                                 |
| **t_reply_callid(callid, cseq, code, reason)**             | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_reply_callid)                       |
| **t_reset_fr()**                                           | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_reset_fr)                              |
| **t_reset_max_lifetime()**                                 | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_reset_max_lifetime)                    |
| **t_reset_retr()**                                         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_reset_retr)                            |
| **t_retransmit_reply()**                                   | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_retransmit_reply)                      |
| **t_reuse_branch()**                                       | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_reuse_branch)                       |
| **t_save_lumps()**                                         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_save_lumps)                            |
| **t_set_auto_inv_100(0\|1)**                               | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_set_auto_inv_100)                      |
| **t_set_disable_6xx(0\|1)**                                | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_set_disable_6xx)                       |
| **t_set_disable_failover(0\|1)**                           | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_set_disable_failover)                  |
| **t_set_disable_internal_reply(0\|1)**                     | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_set_disable_internal_reply)            |
| **t_set_fr(fr_inv_timeout \[, fr_timeout\])**              | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_set_fr)                                |
| **t_set_max_lifetime(inv_lifetime, noninv_lifetime)**      | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_set_max_lifetime)                      |
| **t_set_no_e2e_cancel_reason(0\|1)**                       | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_set_no_e2e_cancel_reason)              |
| **t_set_retr(retr_t1_interval, retr_t2_interval)**         | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_set_retr)                              |
| **t_suspend()**                                            | *modules*   | [tmx](http://www.kamailio.org/docs/modules/4.3.x/modules/tmx.html#tmx.f.t_suspend)                            |
| **t_use_uac_headers()**                                    | *modules*   | [tm](http://www.kamailio.org/docs/modules/4.3.x/modules/tm.html#tm.f.t_use_uac_headers)                       |
...
| **unregister(domain)**                   | *modules*   | [ims_registrar_scscf](http://www.kamailio.org/docs/modules/4.3.x/modules/ims_registrar_scscf.html)        |
| **unregister(domain, uri\[, ruid\])**    | *modules*   | [registrar](http://www.kamailio.org/docs/modules/4.3.x/modules/registrar.html#registrar.f.unregister)     |
| **unset_dlg_profile(profile,\[value\])** | *modules*   | [dialog](http://www.kamailio.org/docs/modules/4.3.x/modules/dialog.html)                                  |
| **unset_dlg_profile(profile,\[value\])** | *modules*   | [dialog_ng](http://www.kamailio.org/docs/modules/4.3.x/modules/dialog_ng.html)                            |
| **update_stat(variable,value)**          | *modules*   | [statistics](http://www.kamailio.org/docs/modules/4.3.x/modules/statistics.html#statistics.f.update_stat) |
| **uri_param(param)**                     | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.3.x/modules/siputils.html)                              |
| **uri_param(param,value)**               | *modules*   | [siputils](http://www.kamailio.org/docs/modules/4.3.x/modules/siputils.html#siputils.f.uri_param_value)   |
| **use_media_proxy()**                    | *modules*   | [mediaproxy](http://www.kamailio.org/docs/modules/4.3.x/modules/mediaproxy.html)                          |
| **use_next_gw()/next_routing()**         | *modules*   | [drouting](http://www.kamailio.org/docs/modules/4.3.x/modules/drouting.html)                              |
| **usleep(time)**                         | *modules*   | [cfgutils](http://www.kamailio.org/docs/modules/4.3.x/modules/cfgutils.html#cfgutils.f.usleep)            |

## \[V\]

| Name                         | Module Path | Module Name                                                                                                   |
|------------------------------|-------------|---------------------------------------------------------------------------------------------------------------|
| **validateospheader()**      | *modules*   | [osp](http://www.kamailio.org/docs/modules/4.3.x/modules/osp.html)                                            |
| **verify_destination()**     | *modules*   | [peering](http://www.kamailio.org/docs/modules/4.3.x/modules/peering.html)                                    |
| **verify_source()**          | *modules*   | [peering](http://www.kamailio.org/docs/modules/4.3.x/modules/peering.html)                                    |
| **vrfy_check_callid()**      | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/4.3.x/modules/auth_identity.html#vrfy_check_callid)      |
| **vrfy_check_certificate()** | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/4.3.x/modules/auth_identity.html#vrfy_check_certificate) |
| **vrfy_check_date()**        | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/4.3.x/modules/auth_identity.html#vrfy_check_date)        |
| **vrfy_check_msgvalidity()** | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/4.3.x/modules/auth_identity.html#vrfy_check_msgvalidity) |
| **vrfy_get_certificate()**   | *modules*   | [auth_identity](http://www.kamailio.org/docs/modules/4.3.x/modules/auth_identity.html#vrfy_get_certificate)   |

## \[W\]

| Name                                                | Module Path | Module Name                                                                                                    |
|-----------------------------------------------------|-------------|----------------------------------------------------------------------------------------------------------------|
| **ws_close(\[status, reason\[, connection_id\]\])** | *modules*   | [websocket](http://www.kamailio.org/docs/modules/4.3.x/modules/websocket.html#websocket.f.ws_close)            |
| **ws_handle_handshake()**                           | *modules*   | [websocket](http://www.kamailio.org/docs/modules/4.3.x/modules/websocket.html#websocket.f.ws_handle_handshake) |
| **www_authenticate(realm, table \[, method\])**     | *modules*   | [auth_db](http://www.kamailio.org/docs/modules/4.3.x/modules/auth_db.html#auth_db.f.www_authenticate)          |
| **www_authorize(realm, table)**                     | *modules*   | [auth_db](http://www.kamailio.org/docs/modules/4.3.x/modules/auth_db.html#auth_db.f.www_authorize)             |
| **www_authorize(realm, table)**                     | *modules*   | [uid_auth_db](http://www.kamailio.org/docs/modules/4.3.x/modules/uid_auth_db.html#www_authorize)               |
| **www_challenge(realm, flags)**                     | *modules*   | [auth](http://www.kamailio.org/docs/modules/4.3.x/modules/auth.html#auth.f.www_challenge)                      |

## \[X\]

| Name                                              | Module Path | Module Name                                                                                     |
|---------------------------------------------------|-------------|-------------------------------------------------------------------------------------------------|
| **xavp_params_explode(sparams, xname)**           | *modules*   | [pv](http://www.kamailio.org/docs/modules/4.3.x/modules/pv.html#pv.f.xavp_params_explode)       |
| **xcaps_del(uri, path)**                          | *modules*   | [xcap_server](http://www.kamailio.org/docs/modules/4.3.x/modules/xcap_server.html)              |
| **xcaps_get(uri, path)**                          | *modules*   | [xcap_server](http://www.kamailio.org/docs/modules/4.3.x/modules/xcap_server.html)              |
| **xcaps_put(uri, path, doc)**                     | *modules*   | [xcap_server](http://www.kamailio.org/docs/modules/4.3.x/modules/xcap_server.html)              |
| **xcap_auth_status(watcher_uri, presentity_uri)** | *modules*   | [utils](http://www.kamailio.org/docs/modules/4.3.x/modules/utils.html#utils.f.xcap_auth_status) |
| **xdbg(format)**                                  | *modules*   | [xlog](http://www.kamailio.org/docs/modules/4.3.x/modules/xlog.html#xlog.f.xdbg)                |
| **xdbgl(format)**                                 | *modules*   | [xlog](http://www.kamailio.org/docs/modules/4.3.x/modules/xlog.html#xlog.f.xdbgl)               |
| **xhttp_reply(code, reason, ctype, body)**        | *modules*   | [xhttp](http://www.kamailio.org/docs/modules/4.3.x/modules/xhttp.html)                          |
| **xlfix_attr($attribute)**                        | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#xlfix_attr)                   |
| **xlog(\[ \[facility,\] level,\] format)**        | *modules*   | [xlog](http://www.kamailio.org/docs/modules/4.3.x/modules/xlog.html#xlog.f.xlog)                |
| **xlogl(\[ \[facility,\] level,\] format)**       | *modules*   | [xlog](http://www.kamailio.org/docs/modules/4.3.x/modules/xlog.html#xlog.f.xlogl)               |
| **xlogm(level, format)**                          | *modules*   | [xlog](http://www.kamailio.org/docs/modules/4.3.x/modules/xlog.html#xlog.f.xlogm)               |
| **xlset_attr($attribute, xl_format)**             | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#avp.f.xlset_attr)             |
| **xlset_destination(xl_format)**                  | *modules*   | [avp](http://www.kamailio.org/docs/modules/4.3.x/modules/avp.html#avp.f.xlset_destination)      |
| **xmlrpc_reply(code, reason)**                    | *modules*   | [xmlrpc](http://www.kamailio.org/docs/modules/4.3.x/modules/xmlrpc.html#xmlrpc.xmlrpc_reply)    |
| **xmpp_send_message()**                           | *modules*   | [xmpp](http://www.kamailio.org/docs/modules/4.3.x/modules/xmpp.html)                            |
| **xpdbg(format)**                                 | *modules*   | [xprint](http://www.kamailio.org/docs/modules/4.3.x/modules/xprint.html#xprint.xpdbg)           |
| **xplog(level, format)**                          | *modules*   | [xprint](http://www.kamailio.org/docs/modules/4.3.x/modules/xprint.html#xprint.xplog)           |
