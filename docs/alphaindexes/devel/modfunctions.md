...
| **reg_from_user(ultable, uri, mode)** | [registrar](https://www.kamailio.org/docs/modules/5.6.x/modules/registrar.html#registrar.f.reg_from_user) |
...
| **tls_set_connect_server_id(srvid)** | [tls_wolfssl](https://www.kamailio.org/docs/modules/5.6.x/modules/tls_wolfssl.html#tls.f.tls_set_connect_server_id) |
...
| **xavp_lshift(xname, idx)** | [pv](https://www.kamailio.org/docs/modules/5.6.x/modules/pv.html#pv.f.xavp_lshift) |
...
| **xavp_push_dst(xname)** | [pv](https://www.kamailio.org/docs/modules/5.6.x/modules/pv.html#pv.f.xavp_push_dst) |
