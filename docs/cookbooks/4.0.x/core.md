...
This parameter controls how the branch parameter is calculated for
stateless forwarding. It also applies to stateful forwarding of ACK
...
<http://www.kamailio.org/docs/docbooks/4.0.x/rpc_list/rpc_list.html#dns.add_a>
...
Function append_branch extends destination set by a new entry.
