# Kamailio SIP Server v4.2.x (stable): Core Cookbook
...
2915.
      ...
      dns_naptr_ignore rfc = yes | no (default yes)
...
closed (too slow). If tcp_async is not enabled, it has no effect.
