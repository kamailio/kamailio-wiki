...
\<fc #0000FF> **Previous devel, current stable, version was 5.2.x
(released on November, 2018), see what was new in that release at:**
\</fc>

-   \<fc
    #0000FF><http://www.kamailio.org/wiki/features/new-in-5.2.x>\</fc>
...
-   Add new rpc functions, to add and remove destinations to the
    ...
    -   <https://www.kamailio.org/docs/modules/devel/modules/dispatcher.html#dispatcher.r.remove>
...
-   <https://www.kamailio.org/docs/modules/devel/modules/evrexec.html#evrexec.r.run>
...
-   <https://kamailio.org/docs/modules/devel/modules/nathelper.html#nathelper.f.nat_uac_test>
...
-   Added t_get_status_code() function to return the status code of the
    ...
    -   <https://www.kamailio.org/docs/modules/devel/modules/tm.html#tm.f.t_get_status_code>
-   Add configuration parameter to add path and flags to redirected
    contacts.
    -   <https://www.kamailio.org/docs/modules/devel/modules/tm.html#tm.p.rich_redirect>
...
More information:
<https://www.kamailio.org/w/2019/05/kamailio-command-line-arguments/>
