...
| **attrs_avp (str)**                                                          | *modules_k* | [dispatcher](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dispatcher.html)     |
...
| **bl_algorithm (string)**                  | *modules*   | [enum](http://www.kamailio.org/docs/modules/3.2.x/modules/enum.html)                   |
...
| **cdr_log_extra (string)**              | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                       |
...
| **cpl_bin_column (string)**             | *modules_k* | [cpl-c](http://www.kamailio.org/docs/modules/3.2.x/modules_k/cpl-c.html)                   |
...
| **db_table_acc (string)**            | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                     |
...
| **db_url(str)**                      | *modules_k* | [presence_xml](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence_xml.html)   |
...
| **diameter_client_host (string)**    | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                     |
...
| **domain_suffix_avp (string)**       | *modules_k* | [domainpolicy](http://www.kamailio.org/docs/modules/3.2.x/modules_k/domainpolicy.html)   |
...
| **fetch_rows (int)**                         | *modules*   | [dialplan](http://www.kamailio.org/docs/modules/3.2.x/modules/dialplan.html)                         |
...
| **fr_inv_timer (integer)**                   | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                                     |
...
| **httpProxy_port (int)**     | *modules_k* | [purple](http://www.kamailio.org/docs/modules/3.2.x/modules_k/purple.html)         |
...
| **mode (integer)**                   | *modules_k* | [memcached](http://www.kamailio.org/docs/modules/3.2.x/modules_k/memcached.html)         |
...
| **peer_tag_avp (AVP string)**                       | *modules_k* | [permissions](http://www.kamailio.org/docs/modules/3.2.x/modules_k/permissions.html)   |
...
| **proxy_route (int)**                               | *modules_k* | [cpl-c](http://www.kamailio.org/docs/modules/3.2.x/modules_k/cpl-c.html)               |
...
| **pv_value (string)**                               | *modules*   | [mtree](http://www.kamailio.org/docs/modules/3.2.x/modules/mtree.html)                 |
| **pv_values (string)**                              | *modules*   | [mtree](http://www.kamailio.org/docs/modules/3.2.x/modules/mtree.html)                 |

## \[Q\]

| Name                       | Module Path | Module Name                                                                          |
|----------------------------|-------------|--------------------------------------------------------------------------------------|
| **qop (string)**           | *modules*   | [auth](http://www.kamailio.org/docs/modules/3.2.x/modules/auth.html)                 |
| **qos_flag (integer)**     | *modules_k* | [qos](http://www.kamailio.org/docs/modules/3.2.x/modules_k/qos.html)                 |
| **query_period(int)**      | *modules_k* | [xcap_client](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xcap_client.html) |
| **queue (integer:string)** | *modules*   | [ratelimit](http://www.kamailio.org/docs/modules/3.2.x/modules/ratelimit.html)       |
| **q_column (string)**      | *modules_k* | [usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/usrloc.html)           |

## \[R\]

| Name                                   | Module Path | Module Name                                                                          |
|----------------------------------------|-------------|--------------------------------------------------------------------------------------|
| **radius_config (string)**             | *modules*   | [peering](http://www.kamailio.org/docs/modules/3.2.x/modules/peering.html)           |
| **radius_config (string)**             | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                 |
| **radius_config (string)**             | *modules_k* | [acc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc_radius.html)   |
| **radius_config (string)**             | *modules_k* | [auth_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/auth_radius.html) |
| **radius_config (string)**             | *modules_k* | [misc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/misc_radius.html) |
| **radius_extra (string)**              | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                 |
| **radius_extra (string)**              | *modules_k* | [acc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc_radius.html)   |
| **radius_flag (integer)**              | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                 |
| **radius_flag (integer)**              | *modules_k* | [acc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc_radius.html)   |
| **radius_missed_flag (integer)**       | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                 |
| **radius_missed_flag (integer)**       | *modules_k* | [acc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc_radius.html)   |
| **raw_interface (string)**             | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/3.2.x/modules/sipcapture.html)     |
| **raw_ipip_capture_on (integer)**      | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/3.2.x/modules/sipcapture.html)     |
| **raw_moni_bpf_on (integer)**          | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/3.2.x/modules/sipcapture.html)     |
| **raw_moni_capture_on (integer)**      | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/3.2.x/modules/sipcapture.html)     |
| **raw_socket_listen (string)**         | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/3.2.x/modules/sipcapture.html)     |
| **raw_sock_children (integer)**        | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/3.2.x/modules/sipcapture.html)     |
| **read_db_url (string)**               | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html)       |
| **realm_prefix (string)**              | *modules_k* | [cpl-c](http://www.kamailio.org/docs/modules/3.2.x/modules_k/cpl-c.html)             |
| **realm_prefix (string)**              | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.2.x/modules_k/registrar.html)     |
| **received_avp (str)**                 | *modules_k* | [nathelper](http://www.kamailio.org/docs/modules/3.2.x/modules_k/nathelper.html)     |
| **received_avp (str)**                 | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.2.x/modules_k/registrar.html)     |
| **received_column (string)**           | *modules_k* | [usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/usrloc.html)           |
| **received_param (string)**            | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.2.x/modules_k/registrar.html)     |
| **reconnect (fixedpoint)**             | *modules_k* | [db_oracle](http://www.kamailio.org/docs/modules/3.2.x/modules_k/db_oracle.html)     |
| **redirection_uri_format**             | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                 |
| **reginfo_increase_version (int)**     | *modules_k* | [pua](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pua.html)                 |
| **register (string)**                  | *modules*   | [app_lua](http://www.kamailio.org/docs/modules/3.2.x/modules/app_lua.html)           |
| **register_myself (integer)**          | *modules_k* | [domain](http://www.kamailio.org/docs/modules/3.2.x/modules_k/domain.html)           |
| **reg_callid_avp (string)**            | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.2.x/modules_k/registrar.html)     |
| **reg_contact_addr (string)**          | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.2.x/modules_k/uac.html)                 |
| **reg_db_table (string)**              | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html)       |
| **reg_db_url (string)**                | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.2.x/modules_k/uac.html)                 |
| **reject_to_small (integer)**          | *modules_k* | [sst](http://www.kamailio.org/docs/modules/3.2.x/modules_k/sst.html)                 |
| **reminder (string)**                  | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)             |
| **remove_latency (integer)**           | *modules_k* | [pike](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pike.html)               |
| **reparse_invite (integer)**           | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                     |
| **reparse_on_dns_failover (integer)**  | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                     |
| **reply_code (integer)**               | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/3.2.x/modules/pipelimit.html)       |
| **reply_dir (string)**                 | *modules_k* | [mi_fifo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_fifo.html)         |
| **reply_indent (string)**              | *modules_k* | [mi_datagram](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_datagram.html) |
| **reply_indent (string)**              | *modules_k* | [mi_fifo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_fifo.html)         |
| **reply_option (integer)**             | *modules_k* | [mi_xmlrpc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_xmlrpc.html)     |
| **reply_reason (string)**              | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/3.2.x/modules/pipelimit.html)       |
| **repl_exp_col (string)**              | *modules*   | [dialplan](http://www.kamailio.org/docs/modules/3.2.x/modules/dialplan.html)         |
| **report_ack (integer)**               | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                 |
| **report_cancels (integer)**           | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                 |
| **reqs_density_per_unit (integer)**    | *modules_k* | [pike](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pike.html)               |
| **require_certificate (boolean)**      | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                   |
| **restart_fr_on_each_reply (integer)** | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                     |
| **retries (integer)**                  | *modules*   | [db_postgres](http://www.kamailio.org/docs/modules/3.2.x/modules/db_postgres.html)   |
| **retry_after (integer)**              | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.2.x/modules_k/registrar.html)     |
| **retry_delay**                        | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                 |
| **retry_limit**                        | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                 |
| **retr_timer1 (integer)**              | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                     |
| **retr_timer2 (integer)**              | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                     |
| **re_exp_column (string)**             | *modules_k* | [group](http://www.kamailio.org/docs/modules/3.2.x/modules_k/group.html)             |
| **re_gid_column (string)**             | *modules_k* | [group](http://www.kamailio.org/docs/modules/3.2.x/modules_k/group.html)             |
| **re_table (string)**                  | *modules_k* | [group](http://www.kamailio.org/docs/modules/3.2.x/modules_k/group.html)             |
| **ring_timeout (int)**                 | *modules_k* | [siputils](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siputils.html)       |
| **risk_group_column (string)**         | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html)       |
| **rlpres_table(str)**                  | *modules_k* | [rls](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rls.html)                 |
| **rlsubs_table(str)**                  | *modules_k* | [rls](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rls.html)                 |
| **rls_event (str)**                    | *modules_k* | [rls](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rls.html)                 |
| **rooms_table (str)**                  | *modules_k* | [imc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/imc.html)                 |
| **route (string)**                     | *modules*   | [xmlrpc](http://www.kamailio.org/docs/modules/3.2.x/modules/xmlrpc.html)             |
| **rpc_heartbeat_timeout (int)**        | *modules*   | [iptrtpproxy](http://www.kamailio.org/docs/modules/3.2.x/modules/iptrtpproxy.html)   |
| **rpid_avp (string)**                  | *modules_k* | [siputils](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siputils.html)       |
| **rpid_prefix (string)**               | *modules_k* | [siputils](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siputils.html)       |
| **rpid_suffix (string)**               | *modules_k* | [siputils](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siputils.html)       |
| **rr_param (string)**                  | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)           |
| **rr_store_param (string)**            | *modules_k* | [uac](http://www.kamailio.org/docs/modules/3.2.x/modules_k/uac.html)                 |
| **rtpproxy_disable_tout (integer)**    | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/3.2.x/modules/rtpproxy.html)         |
| **rtpproxy_retr (integer)**            | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/3.2.x/modules/rtpproxy.html)         |
| **rtpproxy_sock (string)**             | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/3.2.x/modules/rtpproxy.html)         |
| **rtpproxy_tout (integer)**            | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/3.2.x/modules/rtpproxy.html)         |
| **rule_id_column (string)**            | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)                   |
| **ruri_avp (str)**                     | *modules_k* | [drouting](http://www.kamailio.org/docs/modules/3.2.x/modules_k/drouting.html)       |
| **ruri_matching (integer)**            | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                     |
| **ruri_user_avp (AVP string)**         | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)                   |

## \[S\]

| Name                                         | Module Path | Module Name                                                                            |
|----------------------------------------------|-------------|----------------------------------------------------------------------------------------|
| **sampling_time_unit (integer)**             | *modules_k* | [pike](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pike.html)                 |
| **sanity_checks (integer)**                  | *modules*   | [topoh](http://www.kamailio.org/docs/modules/3.2.x/modules/topoh.html)                 |
| **script_cnt_grp_name**                      | *modules*   | [counters](http://www.kamailio.org/docs/modules/3.2.x/modules/counters.html)           |
| **script_counter**                           | *modules*   | [counters](http://www.kamailio.org/docs/modules/3.2.x/modules/counters.html)           |
| **script_name (string)**                     | *modules*   | [app_python](http://www.kamailio.org/docs/modules/3.2.x/modules/app_python.html)       |
| **sc_body (string)**                         | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_ctype (string)**                        | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_exp_time (string)**                     | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_from (string)**                         | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_inc_time (string)**                     | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_mid (string)**                          | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_snd_time (string)**                     | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_to (string)**                           | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_uri_host (string)**                     | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sc_uri_user (string)**                     | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **sdomain_column (string)**                  | *modules_k* | [pdt](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pdt.html)                   |
| **sd_domain_column (string)**                | *modules_k* | [speeddial](http://www.kamailio.org/docs/modules/3.2.x/modules_k/speeddial.html)       |
| **sd_user_column (string)**                  | *modules_k* | [speeddial](http://www.kamailio.org/docs/modules/3.2.x/modules_k/speeddial.html)       |
| **search_scope (string)**                    | *modules_k* | [h350](http://www.kamailio.org/docs/modules/3.2.x/modules_k/h350.html)                 |
| **secret (string)**                          | *modules*   | [auth](http://www.kamailio.org/docs/modules/3.2.x/modules/auth.html)                   |
| **send_close_notify (boolean)**              | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **send_fast_notify (int)**                   | *modules_k* | [presence](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence.html)         |
| **send_socket_avp (string)**                 | *modules_k* | [domainpolicy](http://www.kamailio.org/docs/modules/3.2.x/modules_k/domainpolicy.html) |
| **send_time (int)**                          | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **send_timeout (int)**                       | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **server (int)**                             | *modules*   | [ndb_redis](http://www.kamailio.org/docs/modules/3.2.x/modules/ndb_redis.html)         |
| **server (string)**                          | *modules*   | [pdb](http://www.kamailio.org/docs/modules/3.2.x/modules/pdb.html)                     |
| **servers (str)**                            | *modules_k* | [memcached](http://www.kamailio.org/docs/modules/3.2.x/modules_k/memcached.html)       |
| **servers (string)**                         | *modules*   | [jsonrpc-c](http://www.kamailio.org/docs/modules/3.2.x/modules/jsonrpc-c.html)         |
| **server_address (str)**                     | *modules_k* | [presence](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence.html)         |
| **server_address (str)**                     | *modules_k* | [rls](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rls.html)                   |
| **server_address(str)**                      | *modules_k* | [pua_bla](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pua_bla.html)           |
| **server_address(str)**                      | *modules_k* | [pua_reginfo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pua_reginfo.html)   |
| **server_address(str)**                      | *modules_k* | [pua_xmpp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pua_xmpp.html)         |
| **service_type (integer)**                   | *modules_k* | [acc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc.html)                   |
| **service_type (integer)**                   | *modules_k* | [acc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/acc_radius.html)     |
| **service_type (integer)**                   | *modules_k* | [auth_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/auth_radius.html)   |
| **setid_col (string)**                       | *modules_k* | [dispatcher](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dispatcher.html)     |
| **setid_pvar (str)**                         | *modules_k* | [dispatcher](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dispatcher.html)     |
| **setvars (integer)**                        | *modules_k* | [exec](http://www.kamailio.org/docs/modules/3.2.x/modules_k/exec.html)                 |
| **sflags_column (string)**                   | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **shvset (string)**                          | *modules_k* | [pv](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pv.html)                     |
| **sipEntityType (String)**                   | *modules_k* | [snmpstats](http://www.kamailio.org/docs/modules/3.2.x/modules_k/snmpstats.html)       |
| **sipping_bflag (integer)**                  | *modules_k* | [nathelper](http://www.kamailio.org/docs/modules/3.2.x/modules_k/nathelper.html)       |
| **sipping_from (string)**                    | *modules_k* | [nathelper](http://www.kamailio.org/docs/modules/3.2.x/modules_k/nathelper.html)       |
| **sipping_method (string)**                  | *modules_k* | [nathelper](http://www.kamailio.org/docs/modules/3.2.x/modules_k/nathelper.html)       |
| **sms_report_type (integer)**                | *modules*   | [sms](http://www.kamailio.org/docs/modules/3.2.x/modules/sms.html)                     |
| **snd_time_avp (str)**                       | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)               |
| **snmpCommunity (String)**                   | *modules_k* | [snmpstats](http://www.kamailio.org/docs/modules/3.2.x/modules_k/snmpstats.html)       |
| **snmpgetPath (String)**                     | *modules_k* | [snmpstats](http://www.kamailio.org/docs/modules/3.2.x/modules_k/snmpstats.html)       |
| **socket_column (string)**                   | *modules_k* | [usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/usrloc.html)             |
| **socket_name (string)**                     | *modules_k* | [mi_datagram](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_datagram.html)   |
| **socket_timeout (integer)**                 | *modules_k* | [mi_datagram](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_datagram.html)   |
| **sock_flag (integer)**                      | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.2.x/modules_k/registrar.html)       |
| **sock_hdr_name (string)**                   | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.2.x/modules_k/registrar.html)       |
| **sort_order (int)**                         | *modules_k* | [drouting](http://www.kamailio.org/docs/modules/3.2.x/modules_k/drouting.html)         |
| **source_col (string)**                      | *modules_k* | [permissions](http://www.kamailio.org/docs/modules/3.2.x/modules_k/permissions.html)   |
| **source_networkid_avp**                     | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                   |
| **sp1_uri, sp2_uri, ..., sp16_uri**          | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                   |
| **sp1_weight, sp2_weight, ..., sp16_weight** | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                   |
| **spare_flag_column (string)**               | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html)         |
| **sqlcon (str)**                             | *modules_k* | [sqlops](http://www.kamailio.org/docs/modules/3.2.x/modules_k/sqlops.html)             |
| **sqlres (str)**                             | *modules_k* | [sqlops](http://www.kamailio.org/docs/modules/3.2.x/modules_k/sqlops.html)             |
| **ssl_free_list_max_len (integer)**          | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **ssl_lifetime**                             | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                   |
| **ssl_max_send_fragment (integer)**          | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **ssl_read_ahead (boolean)**                 | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **ssl_release_buffers (integer)**            | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **sst_flag (integer)**                       | *modules_k* | [sst](http://www.kamailio.org/docs/modules/3.2.x/modules_k/sst.html)                   |
| **start_time_column (string)**               | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **state_column (string)**                    | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **status_column (string)**                   | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html)         |
| **step_loops (int)**                         | *modules*   | [debugger](http://www.kamailio.org/docs/modules/3.2.x/modules/debugger.html)           |
| **step_usleep (int)**                        | *modules*   | [debugger](http://www.kamailio.org/docs/modules/3.2.x/modules/debugger.html)           |
| **stopper_column (string)**                  | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)                     |
| **strip_column (string)**                    | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)                     |
| **subscriber_carrier_col (string)**          | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/3.2.x/modules/carrierroute.html)   |
| **subscriber_domain_col (string)**           | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/3.2.x/modules/carrierroute.html)   |
| **subscriber_table (string)**                | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/3.2.x/modules/carrierroute.html)   |
| **subscriber_user_col (string)**             | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/3.2.x/modules/carrierroute.html)   |
| **subst_exp_col (string)**                   | *modules*   | [dialplan](http://www.kamailio.org/docs/modules/3.2.x/modules/dialplan.html)           |
| **subs_htable_size (int)**                   | *modules_k* | [presence](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence.html)         |
| **suffix (string)**                          | *modules_k* | [diversion](http://www.kamailio.org/docs/modules/3.2.x/modules_k/diversion.html)       |
| **switchboard (string)**                     | *modules*   | [iptrtpproxy](http://www.kamailio.org/docs/modules/3.2.x/modules/iptrtpproxy.html)     |

## \[T\]

| Name                                    | Module Path | Module Name                                                                            |
|-----------------------------------------|-------------|----------------------------------------------------------------------------------------|
| **table (str)**                         | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **table (string)**                      | *modules_k* | [group](http://www.kamailio.org/docs/modules/3.2.x/modules_k/group.html)               |
| **table_name (str)**                    | *modules*   | [sipcapture](http://www.kamailio.org/docs/modules/3.2.x/modules/sipcapture.html)       |
| **table_name (string)**                 | *modules*   | [dialplan](http://www.kamailio.org/docs/modules/3.2.x/modules/dialplan.html)           |
| **table_name (string)**                 | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **table_name (string)**                 | *modules_k* | [dispatcher](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dispatcher.html)     |
| **tag_avp (AVP string)**                | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)                     |
| **tag_col (string)**                    | *modules_k* | [permissions](http://www.kamailio.org/docs/modules/3.2.x/modules_k/permissions.html)   |
| **tag_column (string)**                 | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)                     |
| **tel_uri_params (string)**             | *modules*   | [enum](http://www.kamailio.org/docs/modules/3.2.x/modules/enum.html)                   |
| **timeout (fixedpoint)**                | *modules_k* | [db_oracle](http://www.kamailio.org/docs/modules/3.2.x/modules_k/db_oracle.html)       |
| **timeout (integer)**                   | *modules*   | [pdb](http://www.kamailio.org/docs/modules/3.2.x/modules/pdb.html)                     |
| **timeout (integer)**                   | *modules_k* | [memcached](http://www.kamailio.org/docs/modules/3.2.x/modules_k/memcached.html)       |
| **timeout**                             | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                   |
| **timeout_avp (string)**                | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **timeout_avp (string)**                | *modules_k* | [sst](http://www.kamailio.org/docs/modules/3.2.x/modules_k/sst.html)                   |
| **timeout_column (string)**             | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **timeout_interval (integer)**          | *modules*   | [db_mysql](http://www.kamailio.org/docs/modules/3.2.x/modules/db_mysql.html)           |
| **timeout_rm_subs (int)**               | *modules_k* | [presence](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence.html)         |
| **timeout_socket (string)**             | *modules*   | [rtpproxy](http://www.kamailio.org/docs/modules/3.2.x/modules/rtpproxy.html)           |
| **timer (str)**                         | *modules_k* | [rtimer](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rtimer.html)             |
| **timer_avp (string)**                  | *modules_k* | [cpl-c](http://www.kamailio.org/docs/modules/3.2.x/modules_k/cpl-c.html)               |
| **timer_interval (integer)**            | *modules*   | [pipelimit](http://www.kamailio.org/docs/modules/3.2.x/modules/pipelimit.html)         |
| **timer_interval (integer)**            | *modules*   | [ratelimit](http://www.kamailio.org/docs/modules/3.2.x/modules/ratelimit.html)         |
| **timer_interval (integer)**            | *modules_k* | [htable](http://www.kamailio.org/docs/modules/3.2.x/modules_k/htable.html)             |
| **timer_interval (integer)**            | *modules_k* | [usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/usrloc.html)             |
| **timer_mode (integer)**                | *modules_k* | [htable](http://www.kamailio.org/docs/modules/3.2.x/modules_k/htable.html)             |
| **time_to_kill (integer)**              | *modules_k* | [exec](http://www.kamailio.org/docs/modules/3.2.x/modules_k/exec.html)                 |
| **tls_debug (int)**                     | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **tls_disable_compression (boolean)**   | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **tls_force_run (boolean)**             | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **tls_log (int)**                       | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **tls_method (string)**                 | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                     |
| **tname_column (string)**               | *modules*   | [mtree](http://www.kamailio.org/docs/modules/3.2.x/modules/mtree.html)                 |
| **token_format**                        | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                   |
| **toroute_column (string)**             | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **to_presence_code (int)**              | *modules_k* | [rls](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rls.html)                   |
| **to_tag_column (string)**              | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **to_tag_pref (str)**                   | *modules_k* | [presence](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence.html)         |
| **to_uri_column (string)**              | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)             |
| **tprefix_column (string)**             | *modules*   | [mtree](http://www.kamailio.org/docs/modules/3.2.x/modules/mtree.html)                 |
| **traced_user_avp (str)**               | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **trace_flag (integer)**                | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **trace_local_ip (str)**                | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **trace_on (integer)**                  | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **trace_sl_acks (integer)**             | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **trace_table_avp (str)**               | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **trace_to_database (integer)**         | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **transl_tbl (string) := "cfg_transl"** | *modules*   | [cfg_db](http://www.kamailio.org/docs/modules/3.2.x/modules/cfg_db.html)               |
| **transport_column (string)**           | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)                     |
| **transport_override_avp (string)**     | *modules_k* | [domainpolicy](http://www.kamailio.org/docs/modules/3.2.x/modules_k/domainpolicy.html) |
| **trusted_table (string)**              | *modules_k* | [permissions](http://www.kamailio.org/docs/modules/3.2.x/modules_k/permissions.html)   |
| **tvalue_column (string)**              | *modules*   | [mtree](http://www.kamailio.org/docs/modules/3.2.x/modules/mtree.html)                 |
| **type_column (string)**                | *modules*   | [avpops](http://www.kamailio.org/docs/modules/3.2.x/modules/avpops.html)               |

## \[U\]

| Name                                                       | Module Path | Module Name                                                                                          |
|------------------------------------------------------------|-------------|------------------------------------------------------------------------------------------------------|
| **unix_socket_group (integer) unix_socket_group (string)** | *modules_k* | [mi_datagram](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_datagram.html)                 |
| **unix_socket_mode (integer)**                             | *modules_k* | [mi_datagram](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_datagram.html)                 |
| **unix_socket_user (integer) unix_socket_group (string)**  | *modules_k* | [mi_datagram](http://www.kamailio.org/docs/modules/3.2.x/modules_k/mi_datagram.html)                 |
| **unix_tx_timeout (integer)**                              | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                                     |
| **unmatched_cancel (string)**                              | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                                     |
| **uparam_name (str)**                                      | *modules*   | [topoh](http://www.kamailio.org/docs/modules/3.2.x/modules/topoh.html)                               |
| **uparam_prefix (str)**                                    | *modules*   | [topoh](http://www.kamailio.org/docs/modules/3.2.x/modules/topoh.html)                               |
| **update_period (int)**                                    | *modules_k* | [pua](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pua.html)                                 |
| **uriuser_column (string)**                                | *modules_k* | [uri_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/uri_db.html)                           |
| **uri_checks (integer)**                                   | *modules*   | [sanity](http://www.kamailio.org/docs/modules/3.2.x/modules/sanity.html)                             |
| **uri_extra (string)**                                     | *modules_k* | [misc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/misc_radius.html)                 |
| **uri_scheme_column (string)**                             | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)                                   |
| **uri_service_type (integer)**                             | *modules_k* | [misc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/misc_radius.html)                 |
| **url_column (string)**                                    | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html)                       |
| **url_match (str)**                                        | *modules*   | [xhttp](http://www.kamailio.org/docs/modules/3.2.x/modules/xhttp.html)                               |
| **url_match (str)**                                        | *modules*   | [xmlrpc](http://www.kamailio.org/docs/modules/3.2.x/modules/xmlrpc.html)                             |
| **url_skip (str)**                                         | *modules*   | [xhttp](http://www.kamailio.org/docs/modules/3.2.x/modules/xhttp.html)                               |
| **url_skip (str)**                                         | *modules*   | [xmlrpc](http://www.kamailio.org/docs/modules/3.2.x/modules/xmlrpc.html)                             |
| **user (integer or string)**                               | *modules*   | [ctl](http://www.kamailio.org/docs/modules/3.2.x/modules/ctl.html)                                   |
| **username_column (string)**                               | *modules*   | [avpops](http://www.kamailio.org/docs/modules/3.2.x/modules/avpops.html)                             |
| **username_column (string)**                               | *modules_k* | [cpl-c](http://www.kamailio.org/docs/modules/3.2.x/modules_k/cpl-c.html)                             |
| **user_agent_column (string)**                             | *modules_k* | [usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/usrloc.html)                           |
| **user_column (str)**                                      | *modules_k* | [alias_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/alias_db.html)                       |
| **user_column (string)**                                   | *modules_k* | [auth_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/auth_db.html)                         |
| **user_column (string)**                                   | *modules_k* | [group](http://www.kamailio.org/docs/modules/3.2.x/modules_k/group.html)                             |
| **user_column (string)**                                   | *modules_k* | [speeddial](http://www.kamailio.org/docs/modules/3.2.x/modules_k/speeddial.html)                     |
| **user_column (string)**                                   | *modules_k* | [uri_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/uri_db.html)                           |
| **user_column (string)**                                   | *modules_k* | [usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/usrloc.html)                           |
| **use_contact (int)**                                      | *modules_k* | [msilo](http://www.kamailio.org/docs/modules/3.2.x/modules_k/msilo.html)                             |
| **use_contact (integer)**                                  | *modules*   | [sms](http://www.kamailio.org/docs/modules/3.2.x/modules/sms.html)                                   |
| **use_default (int)**                                      | *modules_k* | [dispatcher](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dispatcher.html)                   |
| **use_domain (int)**                                       | *modules*   | [carrierroute](http://www.kamailio.org/docs/modules/3.2.x/modules/carrierroute.html)                 |
| **use_domain (int)**                                       | *modules_k* | [alias_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/alias_db.html)                       |
| **use_domain (int)**                                       | *modules_k* | [auth_diameter](http://www.kamailio.org/docs/modules/3.2.x/modules_k/auth_diameter.html)             |
| **use_domain (int)**                                       | *modules_k* | [drouting](http://www.kamailio.org/docs/modules/3.2.x/modules_k/drouting.html)                       |
| **use_domain (int)**                                       | *modules_k* | [speeddial](http://www.kamailio.org/docs/modules/3.2.x/modules_k/speeddial.html)                     |
| **use_domain (integer)**                                   | *modules*   | [avpops](http://www.kamailio.org/docs/modules/3.2.x/modules/avpops.html)                             |
| **use_domain (integer)**                                   | *modules_k* | [auth_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/auth_db.html)                         |
| **use_domain (integer)**                                   | *modules_k* | [cpl-c](http://www.kamailio.org/docs/modules/3.2.x/modules_k/cpl-c.html)                             |
| **use_domain (integer)**                                   | *modules_k* | [group](http://www.kamailio.org/docs/modules/3.2.x/modules_k/group.html)                             |
| **use_domain (integer)**                                   | *modules_k* | [uri_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/uri_db.html)                           |
| **use_domain (integer)**                                   | *modules_k* | [userblacklist](http://www.kamailio.org/docs/modules/3.2.x/modules_k/userblacklist.html)             |
| **use_domain (integer)**                                   | *modules_k* | [usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/usrloc.html)                           |
| **use_escape_common (int)**                                | *modules_k* | [db_unixodbc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/db_unixodbc.html)                 |
| **use_partial_states (int)**                               | *modules_k* | [presence_conference](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence_conference.html) |
| **use_path (integer)**                                     | *modules_k* | [registrar](http://www.kamailio.org/docs/modules/3.2.x/modules_k/registrar.html)                     |
| **use_received (int)**                                     | *modules_k* | [path](http://www.kamailio.org/docs/modules/3.2.x/modules_k/path.html)                               |
| **use_rpid_for_calling_number**                            | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)                                 |
| **use_ruri_flag (integer)**                                | *modules_k* | [auth_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/auth_radius.html)                 |
| **use_sip_uri_host (integer)**                             | *modules_k* | [misc_radius](http://www.kamailio.org/docs/modules/3.2.x/modules_k/misc_radius.html)                 |
| **use_uri_table (integer)**                                | *modules_k* | [uri_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/uri_db.html)                           |
| **uuid_column (string)**                                   | *modules*   | [avpops](http://www.kamailio.org/docs/modules/3.2.x/modules/avpops.html)                             |

## \[V\]

| Name                                          | Module Path | Module Name                                                                        |
|-----------------------------------------------|-------------|------------------------------------------------------------------------------------|
| **validate_call_id**                          | *modules_k* | [osp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/osp.html)               |
| **value_column (string)**                     | *modules*   | [avpops](http://www.kamailio.org/docs/modules/3.2.x/modules/avpops.html)           |
| **value_type_column (str)**                   | *modules_k* | [htable](http://www.kamailio.org/docs/modules/3.2.x/modules_k/htable.html)         |
| **variable (string)**                         | *modules_k* | [statistics](http://www.kamailio.org/docs/modules/3.2.x/modules_k/statistics.html) |
| **varset (string)**                           | *modules_k* | [pv](http://www.kamailio.org/docs/modules/3.2.x/modules_k/pv.html)                 |
| **vars_h\_entry_column (string)**             | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)         |
| **vars_h\_id_column (string)**                | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)         |
| **vars_key_column (string)**                  | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)         |
| **vars_table_name (string)**                  | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)         |
| **vars_value_column (string)**                | *modules_k* | [dialog](http://www.kamailio.org/docs/modules/3.2.x/modules_k/dialog.html)         |
| **verify_certificate (boolean)**              | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                 |
| **verify_depth (integer)**                    | *modules*   | [tls](http://www.kamailio.org/docs/modules/3.2.x/modules/tls.html)                 |
| **verify_destination_service_type (integer)** | *modules*   | [peering](http://www.kamailio.org/docs/modules/3.2.x/modules/peering.html)         |
| **verify_source_service_type (integer)**      | *modules*   | [peering](http://www.kamailio.org/docs/modules/3.2.x/modules/peering.html)         |
| **version_table (integer)**                   | *modules_k* | [auth_db](http://www.kamailio.org/docs/modules/3.2.x/modules_k/auth_db.html)       |
| **via1_matching (integer)**                   | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)                   |
| **vparam_name (str)**                         | *modules*   | [topoh](http://www.kamailio.org/docs/modules/3.2.x/modules/topoh.html)             |
| **vparam_prefix (str)**                       | *modules*   | [topoh](http://www.kamailio.org/docs/modules/3.2.x/modules/topoh.html)             |

## \[W\]

| Name                         | Module Path | Module Name                                                                    |
|------------------------------|-------------|--------------------------------------------------------------------------------|
| **waitn_time (int)**         | *modules_k* | [rls](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rls.html)           |
| **watchers_table(str)**      | *modules_k* | [presence](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence.html) |
| **weight_column (string)**   | *modules*   | [lcr](http://www.kamailio.org/docs/modules/3.2.x/modules/lcr.html)             |
| **workers (int)**            | *modules*   | [async](http://www.kamailio.org/docs/modules/3.2.x/modules/async.html)         |
| **write_db_url (string)**    | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html) |
| **write_on_db (int)**        | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html) |
| **write_on_master_db (int)** | *modules_k* | [p_usrloc](http://www.kamailio.org/docs/modules/3.2.x/modules_k/p_usrloc.html) |
| **wt_timer (integer)**       | *modules*   | [tm](http://www.kamailio.org/docs/modules/3.2.x/modules/tm.html)               |

## \[X\]

| Name                         | Module Path | Module Name                                                                            |
|------------------------------|-------------|----------------------------------------------------------------------------------------|
| **xcap_root (str)**          | *modules_k* | [rls](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rls.html)                   |
| **xcap_root (str)**          | *modules_k* | [xcap_server](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xcap_server.html)   |
| **xcap_server (str)**        | *modules_k* | [presence_xml](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence_xml.html) |
| **xcap_table (string)**      | *modules*   | [utils](http://www.kamailio.org/docs/modules/3.2.x/modules/utils.html)                 |
| **xcap_table (string)**      | *modules_k* | [xcap_server](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xcap_server.html)   |
| **xcap_table(str)**          | *modules_k* | [presence_xml](http://www.kamailio.org/docs/modules/3.2.x/modules_k/presence_xml.html) |
| **xcap_table(str)**          | *modules_k* | [rls](http://www.kamailio.org/docs/modules/3.2.x/modules_k/rls.html)                   |
| **xcap_table(str)**          | *modules_k* | [xcap_client](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xcap_client.html)   |
| **xheaders_read (integer)**  | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **xheaders_write (integer)** | *modules_k* | [siptrace](http://www.kamailio.org/docs/modules/3.2.x/modules_k/siptrace.html)         |
| **xml_ns (str)**             | *modules*   | [xmlops](http://www.kamailio.org/docs/modules/3.2.x/modules/xmlops.html)               |
| **xml_ns (str)**             | *modules_k* | [xcap_server](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xcap_server.html)   |
| **xmpp_domain (string)**     | *modules_k* | [xmpp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xmpp.html)                 |
| **xmpp_host (string)**       | *modules_k* | [xmpp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xmpp.html)                 |
| **xmpp_password (string)**   | *modules_k* | [xmpp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xmpp.html)                 |
| **xmpp_port (integer)**      | *modules_k* | [xmpp](http://www.kamailio.org/docs/modules/3.2.x/modules_k/xmpp.html)                 |
